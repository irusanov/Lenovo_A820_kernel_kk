...
#define MTK_EXT_DISPLAY_START			HDMI_IO(75)
#define MTK_EXT_DISPLAY_STOP			HDMI_IO(76)
#define MTK_EXT_DISPLAY_SET_MEMORY_INFO		HDMI_IOW(77, struct ext_memory_info)
#define MTK_EXT_DISPLAY_GET_MEMORY_INFO		HDMI_IOW(78, struct ext_memory_info)
#define MTK_EXT_DISPLAY_GET_BUFFER		HDMI_IOW(79, struct ext_buffer)
#define MTK_EXT_DISPLAY_FREE_BUFFER		HDMI_IOW(80, struct ext_buffer)
