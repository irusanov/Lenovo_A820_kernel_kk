...
#define CLDMA_AP_CHNL_IDLE  (0x209C) // DMA channel idle
...
#ifdef MT6290
#define cldma_write32(b, a, v)			iowrite32(v, (b)+(a))
#define cldma_write16(b, a, v)			iowrite16(v, (b)+(a))
#define cldma_write8(b, a, v)			iowrite8(v, (b)+(a))

#define cldma_read32(b, a)				ioread32((b)+(a))
#define cldma_read16(b, a)				ioread16((b)+(a))
#define cldma_read8(b, a)				ioread8((b)+(a))
#else
#include <mach/sync_write.h>
#define cldma_write32(b, a, v)			mt65xx_reg_sync_writel(v, (b)+(a))
#define cldma_write16(b, a, v)			mt65xx_reg_sync_writew(v, (b)+(a))
#define cldma_write8(b, a, v)			mt65xx_reg_sync_writeb(v, (b)+(a))
