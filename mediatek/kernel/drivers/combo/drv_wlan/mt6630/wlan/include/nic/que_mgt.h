...
#define QM_MIN_RESERVED_TC1_RESOURCE    0
...
#define QM_TOTAL_TC_RESOURCE            (NIC_TX_BUFF_COUNT_TC0 + \
                                         NIC_TX_BUFF_COUNT_TC1 + \
                                         NIC_TX_BUFF_COUNT_TC2 + \
                                         NIC_TX_BUFF_COUNT_TC3 + \
                                         NIC_TX_BUFF_COUNT_TC5)

#define QM_TOTAL_GUARANTEED_TC_RESOURCE  (QM_GUARANTEED_TC0_RESOURCE + \
...
#define QM_INITIAL_RESIDUAL_TC_RESOURCE     (QM_TOTAL_TC_RESOURCE - QM_TOTAL_GUARANTEED_TC_RESOURCE)

#define QM_ACTIVE_TC_NUM                    (TC5_INDEX + 1)
