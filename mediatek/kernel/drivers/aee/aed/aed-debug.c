...
#define TEST_PHY_SIZE 0x10000
	...
	aed_combo_exception_api(NULL, 0, (int *)ptr, TEST_PHY_SIZE, __FILE__, DB_OPT_FTRACE);
	kfree(ptr);
...
#define TEST_PHY_SIZE 0x10000
	...
	aed_md32_exception_api((int *)buffer, (int)sizeof(buffer), (int *)ptr, TEST_PHY_SIZE, __FILE__, DB_OPT_FTRACE);
	kfree(ptr);
