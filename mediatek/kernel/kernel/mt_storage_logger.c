...
/*======Thermal PART======*/
static bool enable_mthermal_dump = false;
/*========================*/
/*========Threshold for fs ========*/
...
static struct _loggerMsgFormat thermalLoggerFmt[]=
{
    ...
    MSG_THRML_ARRAY_INDEX(COOL_STAE, "%s%d%s%d", "[Thermal Zone]:%s [Trip]:%d [Cooler]:%s [State]:%d"),
    MSG_THRML_ARRAY_INDEX(TRIP_POINT, "%s%d%d", "[Thermal Zone]:%s [Trip ID]:%d [Trip Point]:%d"),
    MSG_THRML_ARRAY_INDEX(BATTERY_INFO, "%d%d%d", "[fg_batt_crrnt]:%d [batt_vol]:%d [batt_temp]:%d"),
    MSG_THRML_ARRAY_INDEX(CPU_INFO, "%d%d%d%d", "[cpu0_usage]:%d [cpu1_usage]:%d [cpu0_freq]:%d [cpu1_freq]:%d"),
    MSG_THRML_ARRAY_INDEX(CPU_INFO_EX, "%d%d%d%d%d%d%d%d%d%d", "[C0U]:%d [C1U]:%d [C2U]:%d [C3U]:%d [C0F]:%d [C1F]:%d [C2F]:%d [C3F]:%d [GU]:%d [GF]:%d"),
