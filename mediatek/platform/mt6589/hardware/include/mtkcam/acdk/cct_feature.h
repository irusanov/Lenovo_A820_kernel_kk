...
typedef enum
{
    ...
    ACDK_CCT_FEATURE_QUICK_VIEW_IMAGE,
    ACDK_CCT_FEATURE_RESET_LAYER_BUFFER,
    ACDK_CCT_FEATURE_SET_SRC_DEV,
    ACDK_CCT_FEATURE_SET_OPERATION_MODE,

    //Camera Control
    ACDK_CCT_OP_PREVIEW_LCD_START = CCT_CAMCTRL_FEATURE_START,             //start preveiw
    ACDK_CCT_OP_PREVIEW_LCD_STOP,               //stop preview
    ACDK_CCT_OP_SINGLE_SHOT_CAPTURE_EX,         //single shot
    ACDK_CCT_OP_MULTI_SHOT_CAPTURE_EX,          //multi-shot
...
typedef struct MULTI_SHOT_CAPTURE_STRUCT_S
{
    ...
    MBOOL bUnPack;
public :
    MULTI_SHOT_CAPTURE_STRUCT_S(eCAMERA_MODE a_camMode = CAPTURE_MODE,
...
typedef struct
{
    MUINT32 u2PreviewWidth;
    MUINT32 u2PreviewHeight;
