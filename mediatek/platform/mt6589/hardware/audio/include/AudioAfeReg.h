...
#define AFE_DAI_CUR     (0x0098)
#define AFE_DAI_END     (0x009c)
...
#define AFE_MRG_MON0          (0x0270)
#define AFE_MRG_MON1          (0x0274)
#define AFE_MRG_MON2          (0x0278)
...
#define AFE_IRQ5_MCU_EN_CNT_MON (0x03cc)
...
#define FGPA_VERSION            (0x04C8)
#define FGPA_STC                (0x04CC)

#define DBG_MON0                (0x04D0)
#define DBG_MON1                (0x04D4)
#define DBG_MON2                (0x04D8)
#define DBG_MON3                (0x04DC)
#define DBG_MON4                (0x04E0)
#define DBG_MON5                (0x04E4)
#define DBG_MON6                (0x04E8)
...
#define FOC_ROM_SIG             (0x0630)

#define AFE_REGISTER_OFFSET (0x634)
