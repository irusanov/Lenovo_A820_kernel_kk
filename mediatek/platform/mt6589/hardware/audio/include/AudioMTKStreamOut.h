...
class AudioMTKStreamOut : public android_audio_legacy::AudioStreamOut
{
    public:
        ...
        */
        ...
        ssize_t DoBTSCOSRC(const void *buffer, size_t bytes, void **outbuffer, size_t *outputSize);
        ...
        bool  ResetSampleRate(int sampling_rate_new) { return false; }
        bool  StreamOutLock(void) { return false; }
        bool  StreamOutUnlock(void) { return false; }
    ...
    private:
        ...
        class BliSrc
        {
            public:
                ...
                size_t process(const void *inbuffer, size_t bytes, void *outbuffer, size_t *outputSize);
                status_t close();
            private:
                BLI_HANDLE *mHandle;
                uint8_t *mBuffer;
