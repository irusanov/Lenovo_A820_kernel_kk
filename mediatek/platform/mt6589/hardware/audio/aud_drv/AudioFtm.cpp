...
AudioFtm::AudioFtm()
{
    ...
    mAudioAnalogInstance->SetFrequency(AudioAnalogType::DEVICE_IN_ADC, 48000);
...
{
    AudioDigtalI2S AdcI2SOut;
    AdcI2SOut.mLR_SWAP = AudioDigtalI2S::NO_SWAP;
    AdcI2SOut.mI2S_SLAVE = AudioDigtalI2S::MASTER_MODE;
    AdcI2SOut.mINV_LRCK = AudioDigtalI2S::NO_INVERSE;
    AdcI2SOut.mI2S_FMT = AudioDigtalI2S::I2S;
    AdcI2SOut.mI2S_WLEN = AudioDigtalI2S::WLEN_16BITS;
    AdcI2SOut.mI2S_SAMPLERATE = SampleRate;
    mAudioDigitalInstance    ->SetI2SDacOut(&AdcI2SOut);
}
...
void AudioFtm::FTMPMICLoopbackTest(bool bEnable)
{
    ...
    if (bEnable)
    {
        ...
        mAudioAnalogReg->SetAnalogReg(0x4002, 0x8330, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x4004, 0x1801, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x4006, 0x0000, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x4008, 0x1000, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x4012, 0x08e1, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x4014, 0x9e19, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x4024, 0x4000, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x4022, 0x00cf, 0xffff);

        mAudioAnalogReg->SetAnalogReg(0x0714, 0x0d92, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x0718, 0x000c, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x071A, 0xf000, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x0744, 0x102b, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x0746, 0x0000, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x0738, 0x0100, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x070E, 0x0030, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x0702, 0x0008, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x070C, 0x0552, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x073C, 0x0f0f, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x073E, 0x000f, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x0704, 0x0900, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x0706, 0x0082, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x0702, 0x0009, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x0704, 0x0940, 0xffff);

        mAudioAnalogReg->SetAnalogReg(0x0702, 0x000f, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x0704, 0x0100, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x0706, 0x0022, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x073C, 0x0505, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x0712, 0x0001, 0x0001);
...
void AudioFtm::FTMPMICEarpieceLoopbackTest(bool bEnable)
{
    ...
    if (bEnable)
    {
        ...
        mAudioAnalogReg->SetAnalogReg(0x0738, 0x0201, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x070E, 0x0030, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x0702, 0x0008, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x070C, 0x0552, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x073E, 0x000f, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x0706, 0x00A2, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x0702, 0x0001, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x0706, 0x0022, 0xffff);

        mAudioAnalogReg->SetAnalogReg(0x073e, 0x0008, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x0712, 0x0001, 0x0001);
...
void AudioFtm::FTMPMICDualModeLoopbackTest(bool bEnable)
{
    ...
    if (bEnable)
    {
        ...
        mAudioAnalogReg->SetAnalogReg(0x0738, 0x0301, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x070E, 0x0030, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x0702, 0x0008, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x070C, 0x0552, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x073C, 0x0f0f, 0xffff);
        ...
        mAudioAnalogReg->SetAnalogReg(0x0706, 0x0022, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x073C, 0x0505, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x0740, 0x0505, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x0710, 0x0011, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x0712, 0x0001, 0x0001);
        mAudioAnalogReg->SetAnalogReg(0x0700, 0x000f, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x0702, 0x0906, 0xffff);

        mAudioAnalogReg->SetAnalogReg(0x0600, 0x3005, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x0612, 0x0400, 0xffff);
...
int AudioFtm::FMLoopbackTest(char bEnable)
{
    if (bEnable == true)
    {
        ...
        mAudioResourceManager->EnableAudioClock(AudioResourceManagerInterface::CLOCK_AUD_AFE, true);
        mAudioResourceManager->EnableAudioClock(AudioResourceManagerInterface::CLOCK_AUD_ANA, true);
        //todo:: here to do analog loopback enable
        mAudioAnalogReg->SetAnalogReg(0x0106, 0x0003, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x4026, 0x0000, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x4034, 0xC1A1, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x4038, 0x000C, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x403A, 0x0001, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x4038, 0x000E, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x4032, 0x0400, 0xffff);
        ...
        mAudioAnalogReg->SetAnalogReg(0x0738, 0x0001, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x070E, 0x0030, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x0702, 0x0008, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x070C, 0x0552, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x073C, 0x0F0F, 0xffff);
        ...
        mAudioAnalogReg->SetAnalogReg(0x0704, 0x0940, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x0702, 0x000F, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x0704, 0x1100, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x0706, 0x0022, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x073C, 0x0505, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x073A, 0x0005, 0xffff);
    ...
    else
    {
        ...
        mAudioResourceManager->EnableAudioClock(AudioResourceManagerInterface::CLOCK_AUD_AFE, false);
        mAudioResourceManager->EnableAudioClock(AudioResourceManagerInterface::CLOCK_AUD_ANA, false);
        //todo:: here to do analog loopback disable_clock
        mAudioAnalogReg->SetAnalogReg(0x071A, 0x0000, 0xffff); // enable LDO ; fix me , seperate for UL  DL LDO
        mAudioAnalogReg->SetAnalogReg(0x0744, 0x0000, 0xf000); //RG DEV ck onMessageReceived
        mAudioAnalogReg->SetAnalogReg(0x0746, 0x0000, 0xffff); // NCP on
        mAudioAnalogReg->SetAnalogReg(0x0702, 0x0000, 0xffff); // Audio headset power onMessageReceived
        mAudioAnalogReg->SetAnalogReg(0x0712, 0x0001, 0x0001); // reset decoder
        mAudioAnalogReg->SetAnalogReg(0x0700, 0x0000, 0xffff); // power on audio DAC right channels
    }
    return true;
}
...
int AudioFtm::Pmic_I2s_out(char echoflag)
{
    ...
    if (echoflag == true)
    {
        ...
        mAudioAnalogReg->SetAnalogReg(0x0106, 0x0001, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x4026, 0x0000, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x4000, 0x007f, 0xffff);

        mAudioAnalogReg->SetAnalogReg(0x400e, 0x001e, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x4010, 0x0601, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x4020, 0x000F, 0xffff); // I2s output format

        mAudioAnalogReg->SetAnalogReg(0x0712, 0x0002, 0x0002);
        mAudioAnalogReg->SetAnalogReg(0x0714, 0x0880, 0xffff);
        mAudioAnalogReg->SetAnalogReg(0x071A, 0x9000, 0xffff);
