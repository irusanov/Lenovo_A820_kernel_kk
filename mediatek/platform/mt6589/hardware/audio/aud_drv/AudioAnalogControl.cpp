...
AudioAnalogControl::AudioAnalogControl()
{
    ...
    // start trim function
    AnalogSetMux(AudioAnalogType::DEVICE_OUT_EARPIECER , AudioAnalogType::MUX_VOICE);
    AnalogSetMux(AudioAnalogType::DEVICE_OUT_HEADSETL, AudioAnalogType::MUX_AUDIO);
    AnalogSetMux(AudioAnalogType::DEVICE_OUT_HEADSETR, AudioAnalogType::MUX_AUDIO);
    AnalogSetMux(AudioAnalogType::DEVICE_OUT_SPEAKERR , AudioAnalogType::MUX_AUDIO);
    AnalogSetMux(AudioAnalogType::DEVICE_OUT_SPEAKERL , AudioAnalogType::MUX_AUDIO);
    ...
    SetFrequency(AudioAnalogType::DEVICE_OUT_DAC, 44100);

    mAudioMachineDevice->StartHeadphoneTrimFunction();
    mAudioPlatformDevice->AnalogOpen(AudioAnalogType::DEVICE_OUT_SPEAKERR);
    mAudioMachineDevice->StartSpkTrimFunction();
    mAudioPlatformDevice->AnalogClose(AudioAnalogType::DEVICE_OUT_SPEAKERR);
