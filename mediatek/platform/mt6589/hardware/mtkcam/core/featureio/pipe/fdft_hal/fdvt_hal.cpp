...
)
{
    ...
    FDFTInitInfo.SDMaxSmileNum = FDCustomData.SDMaxSmileNum;
...
bool doRGB565Buffer_DDP(MUINT8 *a_dstAddr, MUINT8 *a_srcAddr)
{
    ...
    if(g_ucPlane ==2)
    {
        ...
        FDstream.setSrcConfig(g_FDW, g_FDH, eYUV_420_2P_YVYU);
    }
    ...
    else if(g_ucPlane ==3)
    {
        ...
        FDstream.setSrcBuffer((void**)src_addr_list, src_size_list, g_ucPlane);
        FDstream.setSrcConfig(g_FDW, g_FDH, eYUV_420_3P_YVU);
    }   
...
//***********************************************************************//
    ...
    //if (!FDstream.invalidate())  //trigger HW
