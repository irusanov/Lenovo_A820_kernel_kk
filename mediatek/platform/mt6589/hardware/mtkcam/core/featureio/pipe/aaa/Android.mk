...
#-----------------------------------------------------------
LOCAL_SRC_FILES += aaa_hal_base.cpp
...
LOCAL_C_INCLUDES += \
    ...
    $(LOCAL_PATH)/../../drv/inc \
    $(LOCAL_PATH)/../../drv/cam_cal \
    $(LOCAL_PATH)/state_mgr \
    $(LOCAL_PATH)/awb_mgr \
    $(LOCAL_PATH)/flash_mgr \
    $(LOCAL_PATH)/nvram_mgr \
    $(LOCAL_PATH)/isp_mgr \
    $(LOCAL_PATH)/buf_mgr \
    $(LOCAL_PATH)/ispdrv_mgr \
    $(LOCAL_PATH)/isp_tuning \
    $(LOCAL_PATH)/isp_tuning/paramctrl/inc \
    $(LOCAL_PATH)/isp_tuning/paramctrl/pca_mgr/ \
    $(LOCAL_PATH)/isp_tuning/paramctrl/ccm_mgr/ \
    $(LOCAL_PATH)/lsc_mgr \
    $(LOCAL_PATH)/af_mgr \
    $(LOCAL_PATH)/ae_mgr \
    $(LOCAL_PATH)/sensor_mgr \

LOCAL_C_INCLUDES += \
    $(MTK_PATH_PLATFORM)/hardware/include/mtkcam \
    ...
    $(TOP)/$(MTK_PATH_PLATFORM)/hardware/include/mtkcam/acdk \
