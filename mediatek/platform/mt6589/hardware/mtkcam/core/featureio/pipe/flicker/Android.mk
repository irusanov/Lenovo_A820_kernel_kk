...
#-----------------------------------------------------------
LOCAL_SRC_FILES += flicker_hal.cpp
...
LOCAL_C_INCLUDES += \
    $(LOCAL_PATH)/../../drv/inc \
    $(LOCAL_PATH)/../aaa/isp_mgr \
    $(LOCAL_PATH)/../aaa/ae_mgr \
    $(LOCAL_PATH)/../aaa/af_mgr \
    $(LOCAL_PATH)/../aaa/ispdrv_mgr \
...
LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_PLATFORM)/hardware/mtkcam/core/drv/imgsensor
LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_PLATFORM)/hardware/camera/core/drv/imgsensor
#
