...
#-----------------------------------------------------------
LOCAL_SRC_FILES += nvram/nvram_drv.cpp nvram/nvram_buf_mgr.cpp
LOCAL_SRC_FILES += strobe/strobe_drv.cpp strobe/flashlight_drv.cpp
LOCAL_SRC_FILES += tdri_mgr/tdri_mgr.cpp
LOCAL_SRC_FILES += cam_cal/cam_cal_drv.cpp cam_cal/camera_common_calibration.cpp
#LOCAL_SRC_FILES += eeprom/eeprom_drv.cpp eeprom/camera_common_calibration.cpp

ifneq ($(BUILD_MTK_LDVT),true)
    LOCAL_SRC_FILES += eis/eis_drv.cpp
    LOCAL_SRC_FILES += lce/lce_drv.cpp
...
#
LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_PLATFORM)/hardware/include/mtkcam/algorithm/libeis
