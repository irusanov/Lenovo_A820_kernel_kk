...
=   {   {{0x07C008a8, 0x0000001D, 0x00001102  },  // IC_RAW(0)
        ...
        {{0x07C008a8, 0x0000001D, 0x00001102  },  // VR_RAW(1)
         ...
         {0x00000000, 0x00000000, 0x00000000  },  // DUMMY
         {0x00000000, 0x00000000, 0x00000000  }}, // DUMMY
        {{0x07C00800, 0x0000001D, 0x00001100  },  // ZSD_RAW(2)
         {0x07C008a8, 0x0000001D, 0x00001102  },  // ZSD_YUV
         {0x00000000, 0x00000000, 0x00000000  },  // DUMMY
         {0x00000000, 0x00000000, 0x00000000  },  // DUMMY
         {0x00000000, 0x00000000, 0x00000000  }}, // DUMMY
        {{0x07C008a8, 0x0000001D, 0x00001102  },  // IP_RAW(3)
         {0x07C008a8, 0x0000001D, 0x00001102  },  // IP_YUV
        ...
        {{0x07C008a8, 0x0000001D, 0x00001102  },  // Simultaneous_DUMMY(5)
         ...
         {0x00000000, 0x00000000, 0x00000000  },  // DUMMY
         {0x00000000, 0x00000000, 0x00000000  }}, // DUMMY
        {{0x07C00800, 0x0000001D, 0x00001100  },  // N3D_IC_RAW(6)
         {0x07C008a8, 0x0000001D, 0x00001102  },  // N3D_IC_YUV
         {0x00000000, 0x00000000, 0x00000000  },  // DUMMY
         {0x00000000, 0x00000000, 0x00000000  },  // DUMMY
         {0x00000000, 0x00000000, 0x00000000  }}, // DUMMY
...
isp_reg_t*      IspDrv_B::m_pIspReg;
    ...
    default_func    IspDrv_B::default_setting_function[] = {NULL,NULL,NULL,NULL,
                                                            ...
                                                            IspDrv_B::cam_isp_dgm_cfg,NULL,IspDrv_B::cam_isp_ggm_cfg,NULL,
...
//old
#if 0
    m_pIspDrv->writeReg(0x00005000, 0x08000800);	/* 0x15005000: CAM_GGM_RB_GMT[0] */
    m_pIspDrv->writeReg(0x00005004, 0x08020802);	/* 0x15005004: CAM_GGM_RB_GMT[1] */
    m_pIspDrv->writeReg(0x00005008, 0x08040804);	/* 0x15005008: CAM_GGM_RB_GMT[2] */
    m_pIspDrv->writeReg(0x0000500C, 0x08060806);	/* 0x1500500C: CAM_GGM_RB_GMT[3] */
    m_pIspDrv->writeReg(0x00005010, 0x08080808);	/* 0x15005010: CAM_GGM_RB_GMT[4] */
    m_pIspDrv->writeReg(0x00005014, 0x080A080A);	/* 0x15005014: CAM_GGM_RB_GMT[5] */
    m_pIspDrv->writeReg(0x00005018, 0x080C080C);	/* 0x15005018: CAM_GGM_RB_GMT[6] */
    m_pIspDrv->writeReg(0x0000501C, 0x080E080E);	/* 0x1500501C: CAM_GGM_RB_GMT[7] */
    m_pIspDrv->writeReg(0x00005020, 0x08100810);	/* 0x15005020: CAM_GGM_RB_GMT[8] */
    m_pIspDrv->writeReg(0x00005024, 0x08120812);	/* 0x15005024: CAM_GGM_RB_GMT[9] */
    m_pIspDrv->writeReg(0x00005028, 0x08140814);	/* 0x15005028: CAM_GGM_RB_GMT[10] */
    m_pIspDrv->writeReg(0x0000502C, 0x08160816);	/* 0x1500502C: CAM_GGM_RB_GMT[11] */
    m_pIspDrv->writeReg(0x00005030, 0x08180818);	/* 0x15005030: CAM_GGM_RB_GMT[12] */
    m_pIspDrv->writeReg(0x00005034, 0x081A081A);	/* 0x15005034: CAM_GGM_RB_GMT[13] */
    m_pIspDrv->writeReg(0x00005038, 0x081C081C);	/* 0x15005038: CAM_GGM_RB_GMT[14] */
    m_pIspDrv->writeReg(0x0000503C, 0x081E081E);	/* 0x1500503C: CAM_GGM_RB_GMT[15] */
    m_pIspDrv->writeReg(0x00005040, 0x08200820);	/* 0x15005040: CAM_GGM_RB_GMT[16] */
    m_pIspDrv->writeReg(0x00005044, 0x08220822);	/* 0x15005044: CAM_GGM_RB_GMT[17] */
    m_pIspDrv->writeReg(0x00005048, 0x08240824);	/* 0x15005048: CAM_GGM_RB_GMT[18] */
    m_pIspDrv->writeReg(0x0000504C, 0x08260826);	/* 0x1500504C: CAM_GGM_RB_GMT[19] */
    m_pIspDrv->writeReg(0x00005050, 0x08280828);	/* 0x15005050: CAM_GGM_RB_GMT[20] */
    m_pIspDrv->writeReg(0x00005054, 0x082A082A);	/* 0x15005054: CAM_GGM_RB_GMT[21] */
    m_pIspDrv->writeReg(0x00005058, 0x082C082C);	/* 0x15005058: CAM_GGM_RB_GMT[22] */
    m_pIspDrv->writeReg(0x0000505C, 0x082E082E);	/* 0x1500505C: CAM_GGM_RB_GMT[23] */
    m_pIspDrv->writeReg(0x00005060, 0x08300830);	/* 0x15005060: CAM_GGM_RB_GMT[24] */
    m_pIspDrv->writeReg(0x00005064, 0x06583832);	/* 0x15005064: CAM_GGM_RB_GMT[25] */
    m_pIspDrv->writeReg(0x00005068, 0x08340834);	/* 0x15005068: CAM_GGM_RB_GMT[26] */
    m_pIspDrv->writeReg(0x0000506C, 0x08360836);	/* 0x1500506C: CAM_GGM_RB_GMT[27] */
    m_pIspDrv->writeReg(0x00005070, 0x08380838);	/* 0x15005070: CAM_GGM_RB_GMT[28] */
    m_pIspDrv->writeReg(0x00005074, 0x083A083A);	/* 0x15005074: CAM_GGM_RB_GMT[29] */
    m_pIspDrv->writeReg(0x00005078, 0x083C083C);	/* 0x15005078: CAM_GGM_RB_GMT[30] */
    m_pIspDrv->writeReg(0x0000507C, 0x083E083E);	/* 0x1500507C: CAM_GGM_RB_GMT[31] */
    m_pIspDrv->writeReg(0x00005080, 0x08400840);	/* 0x15005080: CAM_GGM_RB_GMT[32] */
    m_pIspDrv->writeReg(0x00005084, 0x08420842);	/* 0x15005084: CAM_GGM_RB_GMT[33] */
    m_pIspDrv->writeReg(0x00005088, 0x08440844);	/* 0x15005088: CAM_GGM_RB_GMT[34] */
    m_pIspDrv->writeReg(0x0000508C, 0x08460846);	/* 0x1500508C: CAM_GGM_RB_GMT[35] */
    m_pIspDrv->writeReg(0x00005090, 0x08480848);	/* 0x15005090: CAM_GGM_RB_GMT[36] */
    m_pIspDrv->writeReg(0x00005094, 0x084A084A);	/* 0x15005094: CAM_GGM_RB_GMT[37] */
    m_pIspDrv->writeReg(0x00005098, 0x084C084C);	/* 0x15005098: CAM_GGM_RB_GMT[38] */
    m_pIspDrv->writeReg(0x0000509C, 0x084E084E);	/* 0x1500509C: CAM_GGM_RB_GMT[39] */
    m_pIspDrv->writeReg(0x000050A0, 0x08500850);	/* 0x150050A0: CAM_GGM_RB_GMT[40] */
    m_pIspDrv->writeReg(0x000050A4, 0x08520852);	/* 0x150050A4: CAM_GGM_RB_GMT[41] */
    m_pIspDrv->writeReg(0x000050A8, 0x08540854);	/* 0x150050A8: CAM_GGM_RB_GMT[42] */
    m_pIspDrv->writeReg(0x000050AC, 0x08560856);	/* 0x150050AC: CAM_GGM_RB_GMT[43] */
    m_pIspDrv->writeReg(0x000050B0, 0x08580858);	/* 0x150050B0: CAM_GGM_RB_GMT[44] */
    m_pIspDrv->writeReg(0x000050B4, 0x085A085A);	/* 0x150050B4: CAM_GGM_RB_GMT[45] */
    m_pIspDrv->writeReg(0x000050B8, 0x085C085C);	/* 0x150050B8: CAM_GGM_RB_GMT[46] */
    m_pIspDrv->writeReg(0x000050BC, 0x085E085E);	/* 0x150050BC: CAM_GGM_RB_GMT[47] */
    m_pIspDrv->writeReg(0x000050C0, 0x08600860);	/* 0x150050C0: CAM_GGM_RB_GMT[48] */
    m_pIspDrv->writeReg(0x000050C4, 0x08620862);	/* 0x150050C4: CAM_GGM_RB_GMT[49] */
    m_pIspDrv->writeReg(0x000050C8, 0x08640864);	/* 0x150050C8: CAM_GGM_RB_GMT[50] */
    m_pIspDrv->writeReg(0x000050CC, 0x08660866);	/* 0x150050CC: CAM_GGM_RB_GMT[51] */
    m_pIspDrv->writeReg(0x000050D0, 0x08680868);	/* 0x150050D0: CAM_GGM_RB_GMT[52] */
    m_pIspDrv->writeReg(0x000050D4, 0x086A086A);	/* 0x150050D4: CAM_GGM_RB_GMT[53] */
    m_pIspDrv->writeReg(0x000050D8, 0x086C086C);	/* 0x150050D8: CAM_GGM_RB_GMT[54] */
    m_pIspDrv->writeReg(0x000050DC, 0x086E086E);	/* 0x150050DC: CAM_GGM_RB_GMT[55] */
    m_pIspDrv->writeReg(0x000050E0, 0x08700870);	/* 0x150050E0: CAM_GGM_RB_GMT[56] */
    m_pIspDrv->writeReg(0x000050E4, 0x08720872);	/* 0x150050E4: CAM_GGM_RB_GMT[57] */
    m_pIspDrv->writeReg(0x000050E8, 0x08740874);	/* 0x150050E8: CAM_GGM_RB_GMT[58] */
    m_pIspDrv->writeReg(0x000050EC, 0x08760876);	/* 0x150050EC: CAM_GGM_RB_GMT[59] */
    m_pIspDrv->writeReg(0x000050F0, 0x08780878);	/* 0x150050F0: CAM_GGM_RB_GMT[60] */
    m_pIspDrv->writeReg(0x000050F4, 0x087A087A);	/* 0x150050F4: CAM_GGM_RB_GMT[61] */
    m_pIspDrv->writeReg(0x000050F8, 0x087C087C);	/* 0x150050F8: CAM_GGM_RB_GMT[62] */
    m_pIspDrv->writeReg(0x000050FC, 0x087E087E);	/* 0x150050FC: CAM_GGM_RB_GMT[63] */
    m_pIspDrv->writeReg(0x00005100, 0x10801080);	/* 0x15005100: CAM_GGM_RB_GMT[64] */
    m_pIspDrv->writeReg(0x00005104, 0x10841084);	/* 0x15005104: CAM_GGM_RB_GMT[65] */
    m_pIspDrv->writeReg(0x00005108, 0x10881088);	/* 0x15005108: CAM_GGM_RB_GMT[66] */
    m_pIspDrv->writeReg(0x0000510C, 0x108C108C);	/* 0x1500510C: CAM_GGM_RB_GMT[67] */
    m_pIspDrv->writeReg(0x00005110, 0x10901090);	/* 0x15005110: CAM_GGM_RB_GMT[68] */
    m_pIspDrv->writeReg(0x00005114, 0x10941094);	/* 0x15005114: CAM_GGM_RB_GMT[69] */
    m_pIspDrv->writeReg(0x00005118, 0x10981098);	/* 0x15005118: CAM_GGM_RB_GMT[70] */
    m_pIspDrv->writeReg(0x0000511C, 0x109C109C);	/* 0x1500511C: CAM_GGM_RB_GMT[71] */
    m_pIspDrv->writeReg(0x00005120, 0x10A010A0);	/* 0x15005120: CAM_GGM_RB_GMT[72] */
    m_pIspDrv->writeReg(0x00005124, 0x10A410A4);	/* 0x15005124: CAM_GGM_RB_GMT[73] */
    m_pIspDrv->writeReg(0x00005128, 0x10A810A8);	/* 0x15005128: CAM_GGM_RB_GMT[74] */
    m_pIspDrv->writeReg(0x0000512C, 0x10AC10AC);	/* 0x1500512C: CAM_GGM_RB_GMT[75] */
    m_pIspDrv->writeReg(0x00005130, 0x10B010B0);	/* 0x15005130: CAM_GGM_RB_GMT[76] */
    m_pIspDrv->writeReg(0x00005134, 0x10B410B4);	/* 0x15005134: CAM_GGM_RB_GMT[77] */
    m_pIspDrv->writeReg(0x00005138, 0x10B810B8);	/* 0x15005138: CAM_GGM_RB_GMT[78] */
    m_pIspDrv->writeReg(0x0000513C, 0x10BC10BC);	/* 0x1500513C: CAM_GGM_RB_GMT[79] */
    m_pIspDrv->writeReg(0x00005140, 0x10C010C0);	/* 0x15005140: CAM_GGM_RB_GMT[80] */
    m_pIspDrv->writeReg(0x00005144, 0x10C410C4);	/* 0x15005144: CAM_GGM_RB_GMT[81] */
    m_pIspDrv->writeReg(0x00005148, 0x10C810C8);	/* 0x15005148: CAM_GGM_RB_GMT[82] */
    m_pIspDrv->writeReg(0x0000514C, 0x10CC10CC);	/* 0x1500514C: CAM_GGM_RB_GMT[83] */
    m_pIspDrv->writeReg(0x00005150, 0x10D010D0);	/* 0x15005150: CAM_GGM_RB_GMT[84] */
    m_pIspDrv->writeReg(0x00005154, 0x10D410D4);	/* 0x15005154: CAM_GGM_RB_GMT[85] */
    m_pIspDrv->writeReg(0x00005158, 0x10D810D8);	/* 0x15005158: CAM_GGM_RB_GMT[86] */
    m_pIspDrv->writeReg(0x0000515C, 0x10DC10DC);	/* 0x1500515C: CAM_GGM_RB_GMT[87] */
    m_pIspDrv->writeReg(0x00005160, 0x10E010E0);	/* 0x15005160: CAM_GGM_RB_GMT[88] */
    m_pIspDrv->writeReg(0x00005164, 0x10E410E4);	/* 0x15005164: CAM_GGM_RB_GMT[89] */
    m_pIspDrv->writeReg(0x00005168, 0x10E810E8);	/* 0x15005168: CAM_GGM_RB_GMT[90] */
    m_pIspDrv->writeReg(0x0000516C, 0x10EC10EC);	/* 0x1500516C: CAM_GGM_RB_GMT[91] */
    m_pIspDrv->writeReg(0x00005170, 0x10F010F0);	/* 0x15005170: CAM_GGM_RB_GMT[92] */
    m_pIspDrv->writeReg(0x00005174, 0x10F410F4);	/* 0x15005174: CAM_GGM_RB_GMT[93] */
    m_pIspDrv->writeReg(0x00005178, 0x10F810F8);	/* 0x15005178: CAM_GGM_RB_GMT[94] */
    m_pIspDrv->writeReg(0x0000517C, 0x10FC10FC);	/* 0x1500517C: CAM_GGM_RB_GMT[95] */
    m_pIspDrv->writeReg(0x00005180, 0x21002100);	/* 0x15005180: CAM_GGM_RB_GMT[96] */
    m_pIspDrv->writeReg(0x00005184, 0x21082108);	/* 0x15005184: CAM_GGM_RB_GMT[97] */
    m_pIspDrv->writeReg(0x00005188, 0x21102110);	/* 0x15005188: CAM_GGM_RB_GMT[98] */
    m_pIspDrv->writeReg(0x0000518C, 0x21182118);	/* 0x1500518C: CAM_GGM_RB_GMT[99] */
    m_pIspDrv->writeReg(0x00005190, 0x21202120);	/* 0x15005190: CAM_GGM_RB_GMT[100] */
    m_pIspDrv->writeReg(0x00005194, 0x21282128);	/* 0x15005194: CAM_GGM_RB_GMT[101] */
    m_pIspDrv->writeReg(0x00005198, 0x21302130);	/* 0x15005198: CAM_GGM_RB_GMT[102] */
    m_pIspDrv->writeReg(0x0000519C, 0x21382138);	/* 0x1500519C: CAM_GGM_RB_GMT[103] */
    m_pIspDrv->writeReg(0x000051A0, 0x21402140);	/* 0x150051A0: CAM_GGM_RB_GMT[104] */
    m_pIspDrv->writeReg(0x000051A4, 0x21482148);	/* 0x150051A4: CAM_GGM_RB_GMT[105] */
    m_pIspDrv->writeReg(0x000051A8, 0x21502150);	/* 0x150051A8: CAM_GGM_RB_GMT[106] */
    m_pIspDrv->writeReg(0x000051AC, 0x21582158);	/* 0x150051AC: CAM_GGM_RB_GMT[107] */
    m_pIspDrv->writeReg(0x000051B0, 0x21602160);	/* 0x150051B0: CAM_GGM_RB_GMT[108] */
    m_pIspDrv->writeReg(0x000051B4, 0x21682168);	/* 0x150051B4: CAM_GGM_RB_GMT[109] */
    m_pIspDrv->writeReg(0x000051B8, 0x21702170);	/* 0x150051B8: CAM_GGM_RB_GMT[110] */
    m_pIspDrv->writeReg(0x000051BC, 0x21782178);	/* 0x150051BC: CAM_GGM_RB_GMT[111] */
    m_pIspDrv->writeReg(0x000051C0, 0x21802180);	/* 0x150051C0: CAM_GGM_RB_GMT[112] */
    m_pIspDrv->writeReg(0x000051C4, 0x21882188);	/* 0x150051C4: CAM_GGM_RB_GMT[113] */
    m_pIspDrv->writeReg(0x000051C8, 0x21902190);	/* 0x150051C8: CAM_GGM_RB_GMT[114] */
    m_pIspDrv->writeReg(0x000051CC, 0x21982198);	/* 0x150051CC: CAM_GGM_RB_GMT[115] */
    m_pIspDrv->writeReg(0x000051D0, 0x21A021A0);	/* 0x150051D0: CAM_GGM_RB_GMT[116] */
    m_pIspDrv->writeReg(0x000051D4, 0x21A821A8);	/* 0x150051D4: CAM_GGM_RB_GMT[117] */
    m_pIspDrv->writeReg(0x000051D8, 0x21B021B0);	/* 0x150051D8: CAM_GGM_RB_GMT[118] */
    m_pIspDrv->writeReg(0x000051DC, 0x21B821B8);	/* 0x150051DC: CAM_GGM_RB_GMT[119] */
    m_pIspDrv->writeReg(0x000051E0, 0x21C021C0);	/* 0x150051E0: CAM_GGM_RB_GMT[120] */
    m_pIspDrv->writeReg(0x000051E4, 0x21C821C8);	/* 0x150051E4: CAM_GGM_RB_GMT[121] */
    m_pIspDrv->writeReg(0x000051E8, 0x21D021D0);	/* 0x150051E8: CAM_GGM_RB_GMT[122] */
    m_pIspDrv->writeReg(0x000051EC, 0x21D821D8);	/* 0x150051EC: CAM_GGM_RB_GMT[123] */
    m_pIspDrv->writeReg(0x000051F0, 0x21E021E0);	/* 0x150051F0: CAM_GGM_RB_GMT[124] */
    m_pIspDrv->writeReg(0x000051F4, 0x21E821E8);	/* 0x150051F4: CAM_GGM_RB_GMT[125] */
    m_pIspDrv->writeReg(0x000051F8, 0x21F021F0);	/* 0x150051F8: CAM_GGM_RB_GMT[126] */
    m_pIspDrv->writeReg(0x000051FC, 0x21F821F8);	/* 0x150051FC: CAM_GGM_RB_GMT[127] */
    m_pIspDrv->writeReg(0x00005200, 0x82008200);	/* 0x15005200: CAM_GGM_RB_GMT[128] */
    m_pIspDrv->writeReg(0x00005204, 0x82208220);	/* 0x15005204: CAM_GGM_RB_GMT[129] */
    m_pIspDrv->writeReg(0x00005208, 0x82408240);	/* 0x15005208: CAM_GGM_RB_GMT[130] */
    m_pIspDrv->writeReg(0x0000520C, 0x82608260);	/* 0x1500520C: CAM_GGM_RB_GMT[131] */
    m_pIspDrv->writeReg(0x00005210, 0x82808280);	/* 0x15005210: CAM_GGM_RB_GMT[132] */
    m_pIspDrv->writeReg(0x00005214, 0x82A082A0);	/* 0x15005214: CAM_GGM_RB_GMT[133] */
    m_pIspDrv->writeReg(0x00005218, 0x82C082C0);	/* 0x15005218: CAM_GGM_RB_GMT[134] */
    m_pIspDrv->writeReg(0x0000521C, 0x82E082E0);	/* 0x1500521C: CAM_GGM_RB_GMT[135] */
    m_pIspDrv->writeReg(0x00005220, 0x83008300);	/* 0x15005220: CAM_GGM_RB_GMT[136] */
    m_pIspDrv->writeReg(0x00005224, 0x65836583);	/* 0x15005224: CAM_GGM_RB_GMT[137] */
    m_pIspDrv->writeReg(0x00005228, 0x83408340);	/* 0x15005228: CAM_GGM_RB_GMT[138] */
    m_pIspDrv->writeReg(0x0000522C, 0x83608360);	/* 0x1500522C: CAM_GGM_RB_GMT[139] */
    m_pIspDrv->writeReg(0x00005230, 0x83808380);	/* 0x15005230: CAM_GGM_RB_GMT[140] */
    m_pIspDrv->writeReg(0x00005234, 0x83A083A0);	/* 0x15005234: CAM_GGM_RB_GMT[141] */
    m_pIspDrv->writeReg(0x00005238, 0x83C083C0);	/* 0x15005238: CAM_GGM_RB_GMT[142] */
    m_pIspDrv->writeReg(0x0000523C, 0x7FE07FE0);	/* 0x1500523C: CAM_GGM_RB_GMT[143] */
    m_pIspDrv->writeReg(0x00005300, 0x00000800);	/* 0x15005300: CAM_GGM_G_GMT[0] */
    m_pIspDrv->writeReg(0x00005304, 0x00000802);	/* 0x15005304: CAM_GGM_G_GMT[1] */
    m_pIspDrv->writeReg(0x00005308, 0x00000804);	/* 0x15005308: CAM_GGM_G_GMT[2] */
    m_pIspDrv->writeReg(0x0000530C, 0x00000806);	/* 0x1500530C: CAM_GGM_G_GMT[3] */
    m_pIspDrv->writeReg(0x00005310, 0x00000808);	/* 0x15005310: CAM_GGM_G_GMT[4] */
    m_pIspDrv->writeReg(0x00005314, 0x0000080A);	/* 0x15005314: CAM_GGM_G_GMT[5] */
    m_pIspDrv->writeReg(0x00005318, 0x0000080C);	/* 0x15005318: CAM_GGM_G_GMT[6] */
    m_pIspDrv->writeReg(0x0000531C, 0x0000080E);	/* 0x1500531C: CAM_GGM_G_GMT[7] */
    m_pIspDrv->writeReg(0x00005320, 0x00000810);	/* 0x15005320: CAM_GGM_G_GMT[8] */
    m_pIspDrv->writeReg(0x00005324, 0x00000812);	/* 0x15005324: CAM_GGM_G_GMT[9] */
    m_pIspDrv->writeReg(0x00005328, 0x00000814);	/* 0x15005328: CAM_GGM_G_GMT[10] */
    m_pIspDrv->writeReg(0x0000532C, 0x00000816);	/* 0x1500532C: CAM_GGM_G_GMT[11] */
    m_pIspDrv->writeReg(0x00005330, 0x00000818);	/* 0x15005330: CAM_GGM_G_GMT[12] */
    m_pIspDrv->writeReg(0x00005334, 0x0000081A);	/* 0x15005334: CAM_GGM_G_GMT[13] */
    m_pIspDrv->writeReg(0x00005338, 0x0000081C);	/* 0x15005338: CAM_GGM_G_GMT[14] */
    m_pIspDrv->writeReg(0x0000533C, 0x0000081E);	/* 0x1500533C: CAM_GGM_G_GMT[15] */
    m_pIspDrv->writeReg(0x00005340, 0x00000820);	/* 0x15005340: CAM_GGM_G_GMT[16] */
    m_pIspDrv->writeReg(0x00005344, 0x00000822);	/* 0x15005344: CAM_GGM_G_GMT[17] */
    m_pIspDrv->writeReg(0x00005348, 0x00000824);	/* 0x15005348: CAM_GGM_G_GMT[18] */
    m_pIspDrv->writeReg(0x0000534C, 0x00000826);	/* 0x1500534C: CAM_GGM_G_GMT[19] */
    m_pIspDrv->writeReg(0x00005350, 0x00000828);	/* 0x15005350: CAM_GGM_G_GMT[20] */
    m_pIspDrv->writeReg(0x00005354, 0x0000082A);	/* 0x15005354: CAM_GGM_G_GMT[21] */
    m_pIspDrv->writeReg(0x00005358, 0x0000082C);	/* 0x15005358: CAM_GGM_G_GMT[22] */
    m_pIspDrv->writeReg(0x0000535C, 0x0000082E);	/* 0x1500535C: CAM_GGM_G_GMT[23] */
    m_pIspDrv->writeReg(0x00005360, 0x00000830);	/* 0x15005360: CAM_GGM_G_GMT[24] */
    m_pIspDrv->writeReg(0x00005364, 0x00000832);	/* 0x15005364: CAM_GGM_G_GMT[25] */
    m_pIspDrv->writeReg(0x00005368, 0x00000834);	/* 0x15005368: CAM_GGM_G_GMT[26] */
    m_pIspDrv->writeReg(0x0000536C, 0x00000836);	/* 0x1500536C: CAM_GGM_G_GMT[27] */
    m_pIspDrv->writeReg(0x00005370, 0x00000838);	/* 0x15005370: CAM_GGM_G_GMT[28] */
    m_pIspDrv->writeReg(0x00005374, 0x0000083A);	/* 0x15005374: CAM_GGM_G_GMT[29] */
    m_pIspDrv->writeReg(0x00005378, 0x0000083C);	/* 0x15005378: CAM_GGM_G_GMT[30] */
    m_pIspDrv->writeReg(0x0000537C, 0x0000083E);	/* 0x1500537C: CAM_GGM_G_GMT[31] */
    m_pIspDrv->writeReg(0x00005380, 0x00000840);	/* 0x15005380: CAM_GGM_G_GMT[32] */
    m_pIspDrv->writeReg(0x00005384, 0x00000842);	/* 0x15005384: CAM_GGM_G_GMT[33] */
    m_pIspDrv->writeReg(0x00005388, 0x00000844);	/* 0x15005388: CAM_GGM_G_GMT[34] */
    m_pIspDrv->writeReg(0x0000538C, 0x00000846);	/* 0x1500538C: CAM_GGM_G_GMT[35] */
    m_pIspDrv->writeReg(0x00005390, 0x00000848);	/* 0x15005390: CAM_GGM_G_GMT[36] */
    m_pIspDrv->writeReg(0x00005394, 0x0000084A);	/* 0x15005394: CAM_GGM_G_GMT[37] */
    m_pIspDrv->writeReg(0x00005398, 0x0000084C);	/* 0x15005398: CAM_GGM_G_GMT[38] */
    m_pIspDrv->writeReg(0x0000539C, 0x0000084E);	/* 0x1500539C: CAM_GGM_G_GMT[39] */
    m_pIspDrv->writeReg(0x000053A0, 0x00000850);	/* 0x150053A0: CAM_GGM_G_GMT[40] */
    m_pIspDrv->writeReg(0x000053A4, 0x00000852);	/* 0x150053A4: CAM_GGM_G_GMT[41] */
    m_pIspDrv->writeReg(0x000053A8, 0x00000854);	/* 0x150053A8: CAM_GGM_G_GMT[42] */
    m_pIspDrv->writeReg(0x000053AC, 0x00000856);	/* 0x150053AC: CAM_GGM_G_GMT[43] */
    m_pIspDrv->writeReg(0x000053B0, 0x00000858);	/* 0x150053B0: CAM_GGM_G_GMT[44] */
    m_pIspDrv->writeReg(0x000053B4, 0x0000085A);	/* 0x150053B4: CAM_GGM_G_GMT[45] */
    m_pIspDrv->writeReg(0x000053B8, 0x0000085C);	/* 0x150053B8: CAM_GGM_G_GMT[46] */
    m_pIspDrv->writeReg(0x000053BC, 0x0000085E);	/* 0x150053BC: CAM_GGM_G_GMT[47] */
    m_pIspDrv->writeReg(0x000053C0, 0x00000860);	/* 0x150053C0: CAM_GGM_G_GMT[48] */
    m_pIspDrv->writeReg(0x000053C4, 0x00000862);	/* 0x150053C4: CAM_GGM_G_GMT[49] */
    m_pIspDrv->writeReg(0x000053C8, 0x00000864);	/* 0x150053C8: CAM_GGM_G_GMT[50] */
    m_pIspDrv->writeReg(0x000053CC, 0x00000866);	/* 0x150053CC: CAM_GGM_G_GMT[51] */
    m_pIspDrv->writeReg(0x000053D0, 0x00000868);	/* 0x150053D0: CAM_GGM_G_GMT[52] */
    m_pIspDrv->writeReg(0x000053D4, 0x0000086A);	/* 0x150053D4: CAM_GGM_G_GMT[53] */
    m_pIspDrv->writeReg(0x000053D8, 0x0000086C);	/* 0x150053D8: CAM_GGM_G_GMT[54] */
    m_pIspDrv->writeReg(0x000053DC, 0x0000086E);	/* 0x150053DC: CAM_GGM_G_GMT[55] */
    m_pIspDrv->writeReg(0x000053E0, 0x00000870);	/* 0x150053E0: CAM_GGM_G_GMT[56] */
    m_pIspDrv->writeReg(0x000053E4, 0x00000872);	/* 0x150053E4: CAM_GGM_G_GMT[57] */
    m_pIspDrv->writeReg(0x000053E8, 0x00000874);	/* 0x150053E8: CAM_GGM_G_GMT[58] */
    m_pIspDrv->writeReg(0x000053EC, 0x00000876);	/* 0x150053EC: CAM_GGM_G_GMT[59] */
    m_pIspDrv->writeReg(0x000053F0, 0x00000878);	/* 0x150053F0: CAM_GGM_G_GMT[60] */
    m_pIspDrv->writeReg(0x000053F4, 0x0000087A);	/* 0x150053F4: CAM_GGM_G_GMT[61] */
    m_pIspDrv->writeReg(0x000053F8, 0x0000087C);	/* 0x150053F8: CAM_GGM_G_GMT[62] */
    m_pIspDrv->writeReg(0x000053FC, 0x0000087E);	/* 0x150053FC: CAM_GGM_G_GMT[63] */
    m_pIspDrv->writeReg(0x00005400, 0x00001080);	/* 0x15005400: CAM_GGM_G_GMT[64] */
    m_pIspDrv->writeReg(0x00005404, 0x00001084);	/* 0x15005404: CAM_GGM_G_GMT[65] */
    m_pIspDrv->writeReg(0x00005408, 0x00001088);	/* 0x15005408: CAM_GGM_G_GMT[66] */
    m_pIspDrv->writeReg(0x0000540C, 0x0000108C);	/* 0x1500540C: CAM_GGM_G_GMT[67] */
    m_pIspDrv->writeReg(0x00005410, 0x00001090);	/* 0x15005410: CAM_GGM_G_GMT[68] */
    m_pIspDrv->writeReg(0x00005414, 0x00001094);	/* 0x15005414: CAM_GGM_G_GMT[69] */
    m_pIspDrv->writeReg(0x00005418, 0x00001098);	/* 0x15005418: CAM_GGM_G_GMT[70] */
    m_pIspDrv->writeReg(0x0000541C, 0x0000109C);	/* 0x1500541C: CAM_GGM_G_GMT[71] */
    m_pIspDrv->writeReg(0x00005420, 0x000010A0);	/* 0x15005420: CAM_GGM_G_GMT[72] */
    m_pIspDrv->writeReg(0x00005424, 0x000010A4);	/* 0x15005424: CAM_GGM_G_GMT[73] */
    m_pIspDrv->writeReg(0x00005428, 0x000010A8);	/* 0x15005428: CAM_GGM_G_GMT[74] */
    m_pIspDrv->writeReg(0x0000542C, 0x000010AC);	/* 0x1500542C: CAM_GGM_G_GMT[75] */
    m_pIspDrv->writeReg(0x00005430, 0x000010B0);	/* 0x15005430: CAM_GGM_G_GMT[76] */
    m_pIspDrv->writeReg(0x00005434, 0x000010B4);	/* 0x15005434: CAM_GGM_G_GMT[77] */
    m_pIspDrv->writeReg(0x00005438, 0x000010B8);	/* 0x15005438: CAM_GGM_G_GMT[78] */
    m_pIspDrv->writeReg(0x0000543C, 0x000010BC);	/* 0x1500543C: CAM_GGM_G_GMT[79] */
    m_pIspDrv->writeReg(0x00005440, 0x000010C0);	/* 0x15005440: CAM_GGM_G_GMT[80] */
    m_pIspDrv->writeReg(0x00005444, 0x000010C4);	/* 0x15005444: CAM_GGM_G_GMT[81] */
    m_pIspDrv->writeReg(0x00005448, 0x000010C8);	/* 0x15005448: CAM_GGM_G_GMT[82] */
    m_pIspDrv->writeReg(0x0000544C, 0x000010CC);	/* 0x1500544C: CAM_GGM_G_GMT[83] */
    m_pIspDrv->writeReg(0x00005450, 0x000010D0);	/* 0x15005450: CAM_GGM_G_GMT[84] */
    m_pIspDrv->writeReg(0x00005454, 0x000010D4);	/* 0x15005454: CAM_GGM_G_GMT[85] */
    m_pIspDrv->writeReg(0x00005458, 0x000010D8);	/* 0x15005458: CAM_GGM_G_GMT[86] */
    m_pIspDrv->writeReg(0x0000545C, 0x000010DC);	/* 0x1500545C: CAM_GGM_G_GMT[87] */
    m_pIspDrv->writeReg(0x00005460, 0x000010E0);	/* 0x15005460: CAM_GGM_G_GMT[88] */
    m_pIspDrv->writeReg(0x00005464, 0x000010E4);	/* 0x15005464: CAM_GGM_G_GMT[89] */
    m_pIspDrv->writeReg(0x00005468, 0x000010E8);	/* 0x15005468: CAM_GGM_G_GMT[90] */
    m_pIspDrv->writeReg(0x0000546C, 0x000010EC);	/* 0x1500546C: CAM_GGM_G_GMT[91] */
    m_pIspDrv->writeReg(0x00005470, 0x000010F0);	/* 0x15005470: CAM_GGM_G_GMT[92] */
    m_pIspDrv->writeReg(0x00005474, 0x000010F4);	/* 0x15005474: CAM_GGM_G_GMT[93] */
    m_pIspDrv->writeReg(0x00005478, 0x000010F8);	/* 0x15005478: CAM_GGM_G_GMT[94] */
    m_pIspDrv->writeReg(0x0000547C, 0x000010FC);	/* 0x1500547C: CAM_GGM_G_GMT[95] */
    m_pIspDrv->writeReg(0x00005480, 0x00002100);	/* 0x15005480: CAM_GGM_G_GMT[96] */
    m_pIspDrv->writeReg(0x00005484, 0x00002108);	/* 0x15005484: CAM_GGM_G_GMT[97] */
    m_pIspDrv->writeReg(0x00005488, 0x00002110);	/* 0x15005488: CAM_GGM_G_GMT[98] */
    m_pIspDrv->writeReg(0x0000548C, 0x00002118);	/* 0x1500548C: CAM_GGM_G_GMT[99] */
    m_pIspDrv->writeReg(0x00005490, 0x00002120);	/* 0x15005490: CAM_GGM_G_GMT[100] */
    m_pIspDrv->writeReg(0x00005494, 0x00002128);	/* 0x15005494: CAM_GGM_G_GMT[101] */
    m_pIspDrv->writeReg(0x00005498, 0x00002130);	/* 0x15005498: CAM_GGM_G_GMT[102] */
    m_pIspDrv->writeReg(0x0000549C, 0x00002138);	/* 0x1500549C: CAM_GGM_G_GMT[103] */
    m_pIspDrv->writeReg(0x000054A0, 0x00002140);	/* 0x150054A0: CAM_GGM_G_GMT[104] */
    m_pIspDrv->writeReg(0x000054A4, 0x00002148);	/* 0x150054A4: CAM_GGM_G_GMT[105] */
    m_pIspDrv->writeReg(0x000054A8, 0x00002150);	/* 0x150054A8: CAM_GGM_G_GMT[106] */
    m_pIspDrv->writeReg(0x000054AC, 0x00002158);	/* 0x150054AC: CAM_GGM_G_GMT[107] */
    m_pIspDrv->writeReg(0x000054B0, 0x00002160);	/* 0x150054B0: CAM_GGM_G_GMT[108] */
    m_pIspDrv->writeReg(0x000054B4, 0x00002168);	/* 0x150054B4: CAM_GGM_G_GMT[109] */
    m_pIspDrv->writeReg(0x000054B8, 0x00002170);	/* 0x150054B8: CAM_GGM_G_GMT[110] */
    m_pIspDrv->writeReg(0x000054BC, 0x00002178);	/* 0x150054BC: CAM_GGM_G_GMT[111] */
    m_pIspDrv->writeReg(0x000054C0, 0x00002180);	/* 0x150054C0: CAM_GGM_G_GMT[112] */
    m_pIspDrv->writeReg(0x000054C4, 0x00002188);	/* 0x150054C4: CAM_GGM_G_GMT[113] */
    m_pIspDrv->writeReg(0x000054C8, 0x00002190);	/* 0x150054C8: CAM_GGM_G_GMT[114] */
    m_pIspDrv->writeReg(0x000054CC, 0x00002198);	/* 0x150054CC: CAM_GGM_G_GMT[115] */
    m_pIspDrv->writeReg(0x000054D0, 0x000021A0);	/* 0x150054D0: CAM_GGM_G_GMT[116] */
    m_pIspDrv->writeReg(0x000054D4, 0x000021A8);	/* 0x150054D4: CAM_GGM_G_GMT[117] */
    m_pIspDrv->writeReg(0x000054D8, 0x000021B0);	/* 0x150054D8: CAM_GGM_G_GMT[118] */
    m_pIspDrv->writeReg(0x000054DC, 0x000021B8);	/* 0x150054DC: CAM_GGM_G_GMT[119] */
    m_pIspDrv->writeReg(0x000054E0, 0x000021C0);	/* 0x150054E0: CAM_GGM_G_GMT[120] */
    m_pIspDrv->writeReg(0x000054E4, 0x000021C8);	/* 0x150054E4: CAM_GGM_G_GMT[121] */
    m_pIspDrv->writeReg(0x000054E8, 0x000021D0);	/* 0x150054E8: CAM_GGM_G_GMT[122] */
    m_pIspDrv->writeReg(0x000054EC, 0x000021D8);	/* 0x150054EC: CAM_GGM_G_GMT[123] */
    m_pIspDrv->writeReg(0x000054F0, 0x000021E0);	/* 0x150054F0: CAM_GGM_G_GMT[124] */
    m_pIspDrv->writeReg(0x000054F4, 0x000021E8);	/* 0x150054F4: CAM_GGM_G_GMT[125] */
    m_pIspDrv->writeReg(0x000054F8, 0x000021F0);	/* 0x150054F8: CAM_GGM_G_GMT[126] */
    m_pIspDrv->writeReg(0x000054FC, 0x000021F8);	/* 0x150054FC: CAM_GGM_G_GMT[127] */
    m_pIspDrv->writeReg(0x00005500, 0x00008200);	/* 0x15005500: CAM_GGM_G_GMT[128] */
    m_pIspDrv->writeReg(0x00005504, 0x00008220);	/* 0x15005504: CAM_GGM_G_GMT[129] */
    m_pIspDrv->writeReg(0x00005508, 0x00008240);	/* 0x15005508: CAM_GGM_G_GMT[130] */
    m_pIspDrv->writeReg(0x0000550C, 0x00008260);	/* 0x1500550C: CAM_GGM_G_GMT[131] */
    m_pIspDrv->writeReg(0x00005510, 0x00008280);	/* 0x15005510: CAM_GGM_G_GMT[132] */
    m_pIspDrv->writeReg(0x00005514, 0x000082A0);	/* 0x15005514: CAM_GGM_G_GMT[133] */
    m_pIspDrv->writeReg(0x00005518, 0x000082C0);	/* 0x15005518: CAM_GGM_G_GMT[134] */
    m_pIspDrv->writeReg(0x0000551C, 0x000082E0);	/* 0x1500551C: CAM_GGM_G_GMT[135] */
    m_pIspDrv->writeReg(0x00005520, 0x00008300);	/* 0x15005520: CAM_GGM_G_GMT[136] */
    m_pIspDrv->writeReg(0x00005524, 0x00006583);	/* 0x15005524: CAM_GGM_G_GMT[137] */
    m_pIspDrv->writeReg(0x00005528, 0x00008340);	/* 0x15005528: CAM_GGM_G_GMT[138] */
    m_pIspDrv->writeReg(0x0000552C, 0x00008360);	/* 0x1500552C: CAM_GGM_G_GMT[139] */
    m_pIspDrv->writeReg(0x00005530, 0x00008380);	/* 0x15005530: CAM_GGM_G_GMT[140] */
    m_pIspDrv->writeReg(0x00005534, 0x000083A0);	/* 0x15005534: CAM_GGM_G_GMT[141] */
    m_pIspDrv->writeReg(0x00005538, 0x000083C0);	/* 0x15005538: CAM_GGM_G_GMT[142] */
    m_pIspDrv->writeReg(0x0000553C, 0x00007FE0);	/* 0x1500553C: CAM_GGM_G_GMT[143] */
...
int ret = 0;
    ...
    ISP_FUNC_INF("mInitCount(%d) m_fgIsGdmaMode: %d.", mInitCount, m_fgIsGdmaMode);
    //
    if(mInitCount > 0)
    {
    ...
    ISP_FUNC_DBG("%s:[base_pAddr:0x%08X]/[ofst_addr:0x%08X] ",this->name_Str(),this->dma_cfg.memBuf.base_pAddr,this->dma_cfg.memBuf.ofst_addr);
     ...
     switch(this->id())
     {
        ...
        case ISP_DMA_IMGI:
            if(m_pIspDrv->IsReadOnlyMode())
            {
                ISP_IOCTL_WRITE_REG(m_pIspDrv, m_pIspDrv->getRegAddrMap(), CAM_IMGI_BASE_ADDR, this->dma_cfg.memBuf.base_pAddr + this->dma_cfg.memBuf.ofst_addr);
                ISP_IOCTL_WRITE_REG(m_pIspDrv, m_pIspDrv->getRegAddrMap(), CAM_IMGI_XSIZE, ( ((((this->dma_cfg.size.w * this->dma_cfg.pixel_byte + 0x03)>> CAM_ISP_PIXEL_BYTE_FP )+1)>>1)<<1) - 1);
                ISP_IOCTL_WRITE_REG(m_pIspDrv, m_pIspDrv->getRegAddrMap(), CAM_IMGI_YSIZE, this->dma_cfg.size.h - 1);//ySize;
            ...
            {
                ISP_WRITE_REG(m_pIspReg, CAM_IMGI_BASE_ADDR, this->dma_cfg.memBuf.base_pAddr + this->dma_cfg.memBuf.ofst_addr);
                //ISP_REG(m_pIspReg, CAM_IMGI_OFST_ADDR) = this->dma_cfg.memBuf.ofst_addr;
                //rounding
                //ISP_REG(m_pIspReg, CAM_IMGI_XSIZE) = ( (this->dma_cfg.size.w * this->dma_cfg.pixel_byte)>> CAM_ISP_PIXEL_BYTE_FP ) - 1;
                ISP_WRITE_REG(m_pIspReg, CAM_IMGI_XSIZE, ( ((((this->dma_cfg.size.w * this->dma_cfg.pixel_byte + 0x03)>> CAM_ISP_PIXEL_BYTE_FP )+1)>>1)<<1) - 1);
                ISP_WRITE_REG(m_pIspReg, CAM_IMGI_YSIZE, this->dma_cfg.size.h - 1);//ySize;
        ...
        case ISP_DMA_IMGCI:
            ...
            {
                ISP_WRITE_REG(m_pIspReg, CAM_IMGCI_BASE_ADDR, this->dma_cfg.memBuf.base_pAddr + this->dma_cfg.memBuf.ofst_addr);
                //ISP_REG(m_pIspReg, CAM_IMGCI_OFST_ADDR) = this->dma_cfg.memBuf.ofst_addr;
                ISP_WRITE_REG(m_pIspReg, CAM_IMGCI_XSIZE, ( (this->dma_cfg.size.w * this->dma_cfg.pixel_byte)>> CAM_ISP_PIXEL_BYTE_FP ) - 1);
                ISP_WRITE_REG(m_pIspReg, CAM_IMGCI_YSIZE, this->dma_cfg.size.h - 1);//ySize;
                ISP_WRITE_BITS(m_pIspReg, CAM_IMGCI_STRIDE,SWAP, this->dma_cfg.swap);
                ISP_WRITE_BITS(m_pIspReg, CAM_IMGCI_STRIDE,FORMAT_EN, this->dma_cfg.format_en);
                ISP_WRITE_BITS(m_pIspReg, CAM_IMGCI_STRIDE,FORMAT, this->dma_cfg.format);
                ISP_WRITE_BITS(m_pIspReg, CAM_IMGCI_STRIDE,BUS_SIZE_EN, this->dma_cfg.bus_size_en);
                ISP_WRITE_BITS(m_pIspReg, CAM_IMGCI_STRIDE,BUS_SIZE, this->dma_cfg.bus_size);
                ISP_WRITE_BITS(m_pIspReg, CAM_IMGCI_STRIDE,STRIDE, ((this->dma_cfg.size.stride* this->dma_cfg.pixel_byte)>> CAM_ISP_PIXEL_BYTE_FP ));
                ISP_WRITE_REG(m_pIspReg, CAM_IMGCI_CON, 0x080B0220);
            }
            break;
        case ISP_DMA_VIPI:
            if(m_pIspDrv->IsReadOnlyMode())
            ...
            {
                ISP_WRITE_REG(m_pIspReg, CAM_VIPI_BASE_ADDR, this->dma_cfg.memBuf.base_pAddr + this->dma_cfg.memBuf.ofst_addr);
                //ISP_REG(m_pIspReg, CAM_VIPI_OFST_ADDR) = this->dma_cfg.memBuf.ofst_addr;
                ISP_WRITE_REG(m_pIspReg, CAM_VIPI_XSIZE, ( (this->dma_cfg.size.w * this->dma_cfg.pixel_byte)>> CAM_ISP_PIXEL_BYTE_FP ) - 1);
                ISP_WRITE_REG(m_pIspReg, CAM_VIPI_YSIZE, this->dma_cfg.size.h - 1);//ySize;
                ISP_WRITE_BITS(m_pIspReg, CAM_VIPI_STRIDE,SWAP, this->dma_cfg.swap);
                ISP_WRITE_BITS(m_pIspReg, CAM_VIPI_STRIDE,FORMAT_EN, this->dma_cfg.format_en);
                ISP_WRITE_BITS(m_pIspReg, CAM_VIPI_STRIDE,FORMAT, this->dma_cfg.format);
                ISP_WRITE_BITS(m_pIspReg, CAM_VIPI_STRIDE,BUS_SIZE_EN, this->dma_cfg.bus_size_en);
                ISP_WRITE_BITS(m_pIspReg, CAM_VIPI_STRIDE,BUS_SIZE, this->dma_cfg.bus_size);
                ISP_WRITE_BITS(m_pIspReg, CAM_VIPI_STRIDE,STRIDE, ((this->dma_cfg.size.stride* this->dma_cfg.pixel_byte)>> CAM_ISP_PIXEL_BYTE_FP ));
                ISP_WRITE_REG(m_pIspReg, CAM_VIPI_CON, 0xC11F1F20);

                ISP_WRITE_BITS(m_pIspReg, CAM_VIPI_RING_BUF,RING_SIZE, this->dma_cfg.ring_size);
                ISP_WRITE_BITS(m_pIspReg, CAM_VIPI_RING_BUF,EN, this->dma_cfg.ring_en);
            }
        ...
        case ISP_DMA_VIP2I:
            ...
            {
                ISP_WRITE_REG(m_pIspReg, CAM_VIP2I_BASE_ADDR, this->dma_cfg.memBuf.base_pAddr + this->dma_cfg.memBuf.ofst_addr);
                //ISP_REG(m_pIspReg, CAM_VIP2I_OFST_ADDR) = this->dma_cfg.memBuf.ofst_addr;
                ISP_WRITE_REG(m_pIspReg, CAM_VIP2I_XSIZE, ( (this->dma_cfg.size.w * this->dma_cfg.pixel_byte)>> CAM_ISP_PIXEL_BYTE_FP ) - 1);
                ISP_WRITE_REG(m_pIspReg, CAM_VIP2I_YSIZE, this->dma_cfg.size.h - 1);//ySize;
                ISP_WRITE_BITS(m_pIspReg, CAM_VIP2I_STRIDE,FORMAT_EN, this->dma_cfg.format_en);
                ISP_WRITE_BITS(m_pIspReg, CAM_VIP2I_STRIDE,FORMAT, this->dma_cfg.format);
                ISP_WRITE_BITS(m_pIspReg, CAM_VIP2I_STRIDE,STRIDE, ((this->dma_cfg.size.stride* this->dma_cfg.pixel_byte)>> CAM_ISP_PIXEL_BYTE_FP ));
                ISP_WRITE_REG(m_pIspReg, CAM_VIP2I_CON, 0x080A0714);
                ISP_WRITE_BITS(m_pIspReg, CAM_VIP2I_RING_BUF,RING_SIZE, this->dma_cfg.ring_size);
                ISP_WRITE_BITS(m_pIspReg, CAM_VIP2I_RING_BUF,EN, this->dma_cfg.ring_en);
            }
...
#else //ultra-highest
                ISP_IOCTL_WRITE_REG(m_pIspDrv, m_pIspDrv->getRegAddrMap(), CAM_LSCI_CON, 0x08000020);
#endif
            }
            else
            {
...
#else //ultra-highest
                ISP_WRITE_REG(m_pIspReg, CAM_LSCI_CON, 0x08000020);
#endif
        ...
        case ISP_DMA_LCEI:
            ...
            {
                ISP_WRITE_REG(m_pIspReg, CAM_LCEI_BASE_ADDR, this->dma_cfg.memBuf.base_pAddr + this->dma_cfg.memBuf.ofst_addr);
                ISP_WRITE_REG(m_pIspReg, CAM_LCEI_XSIZE, ( (this->dma_cfg.size.w * this->dma_cfg.pixel_byte)>> CAM_ISP_PIXEL_BYTE_FP ) - 1);
                ISP_WRITE_REG(m_pIspReg, CAM_LCEI_YSIZE, this->dma_cfg.size.h - 1);//ySize;
                ISP_WRITE_BITS(m_pIspReg, CAM_LCEI_STRIDE,SWAP, this->dma_cfg.swap);
                ISP_WRITE_BITS(m_pIspReg, CAM_LCEI_STRIDE,FORMAT_EN, this->dma_cfg.format_en);
                ISP_WRITE_BITS(m_pIspReg, CAM_LCEI_STRIDE,FORMAT, this->dma_cfg.format);
                ISP_WRITE_BITS(m_pIspReg, CAM_LCEI_STRIDE,BUS_SIZE_EN, this->dma_cfg.bus_size_en);
                ISP_WRITE_BITS(m_pIspReg, CAM_LCEI_STRIDE,BUS_SIZE, this->dma_cfg.bus_size);
                ISP_WRITE_BITS(m_pIspReg, CAM_LCEI_STRIDE,STRIDE, ((this->dma_cfg.size.stride* this->dma_cfg.pixel_byte)>> CAM_ISP_PIXEL_BYTE_FP ));
                ISP_WRITE_REG(m_pIspReg, CAM_LCEI_CON, 0x080B0220);
     ...
     switch(this->id())
     {
        ...
        case ISP_DMA_P2_IMG2O:
            if(m_pIspDrv->IsReadOnlyMode())
            {
                ...
                //                (((( (this->dma_cfg.size.w * this->dma_cfg.pixel_byte + 0x03)>> CAM_ISP_PIXEL_BYTE_FP )+1)>>1)<<1) - 1);
                //@TODO
                ISP_IOCTL_WRITE_REG(m_pIspDrv, m_pIspDrv->getRegAddrMap(), CAM_IMG2O_XSIZE, 0x2C0-1);

                ISP_IOCTL_WRITE_REG(m_pIspDrv, m_pIspDrv->getRegAddrMap(), CAM_IMG2O_YSIZE, this->dma_cfg.size.h - 1);//ySize;
                //ISP_IOCTL_WRITE_REG(m_pIspDrv, m_pIspDrv->getRegAddrMap(), CAM_IMG2O_STRIDE, (this->dma_cfg.size.stride* this->dma_cfg.pixel_byte) >> CAM_ISP_PIXEL_BYTE_FP);//stride;
                //@TODO
                ISP_IOCTL_WRITE_REG(m_pIspDrv, m_pIspDrv->getRegAddrMap(), CAM_IMG2O_STRIDE, 0x009902C0);
                ISP_IOCTL_WRITE_REG(m_pIspDrv, m_pIspDrv->getRegAddrMap(), CAM_IMG2O_CON, 0x08101040);  // ultra-high for pass1, not for 3DNR
                ISP_IOCTL_WRITE_REG(m_pIspDrv, m_pIspDrv->getRegAddrMap(), CAM_IMG2O_CON2, 0x00101000);
                ISP_IOCTL_WRITE_REG(m_pIspDrv, m_pIspDrv->getRegAddrMap(), CAM_IMG2O_CROP, (this->dma_cfg.crop.y << 16) | this->dma_cfg.crop.x);
                //
                //ISP_IOCTL_WRITE_BITS(m_pIspDrv, m_pIspDrv->getRegAddrMap(), CAM_CTL_DMA_INT, IMG2O_DONE_EN, 1);	//NG
                //ISP_IOCTL_WRITE_BITS(m_pIspDrv, m_pIspDrv->getRegAddrMap(), CAM_CTL_MUX_SEL, NR3O_SEL_EN, 1);
                //ISP_IOCTL_WRITE_BITS(m_pIspDrv, m_pIspDrv->getRegAddrMap(), CAM_CTL_MUX_SEL_CLR, NR3O_SEL_EN_CLR, 0);
                //ISP_IOCTL_WRITE_BITS(m_pIspDrv, m_pIspDrv->getRegAddrMap(), CAM_CTL_MUX_SEL_SET, NR3O_SEL_EN_SET, 1);

                //ISP_IOCTL_WRITE_BITS(m_pIspDrv, m_pIspDrv->getRegAddrMap(), CAM_CTL_IMG2O_FBC, FBC_EN, 0);
                //ISP_IOCTL_WRITE_BITS(m_pIspDrv, m_pIspDrv->getRegAddrMap(), CAM_CTL_MUX_SEL2, IMG2O_MUX_EN, 1);
                //ISP_IOCTL_WRITE_BITS(m_pIspDrv, m_pIspDrv->getRegAddrMap(), CAM_CTL_SRAM_MUX_CFG, SRAM_MUX_SCENARIO, 0);

                //@TODO set as 1
                //ISP_IOCTL_WRITE_BITS(m_pIspDrv, m_pIspDrv->getRegAddrMap(), CAM_CTL_EN2, NR3D_EN, 1);
                //@TODO set as 1
                //ISP_IOCTL_WRITE_BITS(m_pIspDrv, m_pIspDrv->getRegAddrMap(), CAM_CTL_DMA_EN, VIPI_EN, 1);
            ...
            else
            {
                ...
                //ISP_WRITE_REG(m_pIspReg, CAM_IMG2O_XSIZE,
                //                (((( (this->dma_cfg.size.w * this->dma_cfg.pixel_byte + 0x03)>> CAM_ISP_PIXEL_BYTE_FP )+1)>>1)<<1) - 1);
                ISP_WRITE_REG(m_pIspReg, CAM_IMG2O_XSIZE, 0x2C0-1);

                ISP_WRITE_REG(m_pIspReg, CAM_IMG2O_YSIZE, this->dma_cfg.size.h - 1);//ySize;
                //ISP_WRITE_REG(m_pIspReg, CAM_IMG2O_STRIDE, (this->dma_cfg.size.stride* this->dma_cfg.pixel_byte) >> CAM_ISP_PIXEL_BYTE_FP);//stride;
                ISP_WRITE_REG(m_pIspReg, CAM_IMG2O_STRIDE, 0x009902C0);
                ISP_WRITE_REG(m_pIspReg, CAM_IMG2O_CON, 0x08101040); //ultra-high for pass1, not for 3DNR
                ISP_WRITE_REG(m_pIspReg, CAM_IMG2O_CON2, 0x00101000);
                ISP_WRITE_REG(m_pIspReg, CAM_IMG2O_CROP, (this->dma_cfg.crop.y << 16) | this->dma_cfg.crop.x);
				...
				//[NR3D]
				//2
		        //ISP_WRITE_BITS(this->m_pIspReg, CAM_CTL_SEL, NR3D_DMA_SEL, 1);
		        //ISP_WRITE_BITS(this->m_pIspReg, CAM_CTL_SEL_CLR, NR3D_DMA_SEL_CLR, 0);
		        //ISP_WRITE_BITS(this->m_pIspReg, CAM_CTL_SEL_SET, NR3D_DMA_SEL_SET, 1);

		        //ISP_WRITE_BITS(this->m_pIspReg, CAM_CTL_DMA_INT, IMG2O_DONE_EN, 1);	//NG
		        //ISP_WRITE_BITS(this->m_pIspReg, CAM_CTL_MUX_SEL, NR3O_SEL_EN, 1);
		        //ISP_WRITE_BITS(this->m_pIspReg, CAM_CTL_MUX_SEL_CLR, NR3O_SEL_EN_CLR, 0);
		        //ISP_WRITE_BITS(this->m_pIspReg, CAM_CTL_MUX_SEL_SET, NR3O_SEL_EN_SET, 1);

		        //ISP_WRITE_BITS(this->m_pIspReg, CAM_CTL_IMG2O_FBC, FBC_EN, 0);
		        //ISP_WRITE_BITS(this->m_pIspReg, CAM_CTL_MUX_SEL2, IMG2O_MUX_EN, 1);
		        //ISP_WRITE_BITS(this->m_pIspReg, CAM_CTL_MUX_SEL2_CLR, IMG2O_MUX_EN_CLR, 0);
		        //ISP_WRITE_BITS(this->m_pIspReg, CAM_CTL_MUX_SEL2_SET, IMG2O_MUX_EN_SET, 1);
		        //ISP_WRITE_BITS(this->m_pIspReg, CAM_CTL_SRAM_MUX_CFG, SRAM_MUX_SCENARIO, 0);
		        //ISP_WRITE_BITS(this->m_pIspReg, CAM_CTL_SRAM_MUX_CFG_CLR, SRAM_MUX_SCENARIO_CLR, 0);
		        //ISP_WRITE_BITS(this->m_pIspReg, CAM_CTL_SRAM_MUX_CFG_SET, SRAM_MUX_SCENARIO_SET, 1);
				//@TODO remove this
		        //ISP_WRITE_BITS(this->m_pIspReg, CAM_CTL_TCM_EN, TDR_EN, 0);


				//3
		        //ISP_WRITE_BITS(this->m_pIspReg, CAM_CTL_EN2, NR3D_EN, 1);	//@TODO set to 1
		        //ISP_WRITE_BITS(this->m_pIspReg, CAM_CTL_DMA_EN, VIPI_EN, 1);	//@TODO set to 1
...
unsigned int turnEn1Tag=0x00, turnEn2Tag=0x00, turnDmaTag=0x00;
    ...
    if (m_pPhyIspDrv->IsReadOnlyMode())
    {
...
#if 0
        // ultra-high
        ISP_IOCTL_WRITE_REG(m_pPhyIspDrv, m_pPhyIspDrv->getRegAddrMap(),CAM_ESFKO_CON, 0x080A0A10);
...
#else
        // ultra-highest
        ISP_IOCTL_WRITE_REG(m_pPhyIspDrv, m_pPhyIspDrv->getRegAddrMap(),CAM_ESFKO_CON, 0x08000010);//0x080A0A10);
        ...
        ISP_IOCTL_WRITE_REG(m_pPhyIspDrv, m_pPhyIspDrv->getRegAddrMap(),CAM_LSCI_CON, 0x08000020);//0x08161620
    ...
    else
    {
...
#if 0
        //ultra-high
        ISP_WRITE_REG(m_pPhyIspReg,CAM_ESFKO_CON, 0x080A0A10);
...
#else
        //ultra-highest
        ISP_WRITE_REG(m_pPhyIspReg,CAM_ESFKO_CON, 0x08000010);  //0x080A0A10
        ...
        ISP_WRITE_REG(m_pPhyIspReg,CAM_LSCI_CON, 0x08000020);   //0x08161620
    ...
    if (ISP_PASS1 == this->path) {
        ...
        if (m_pIspDrv->IsReadOnlyMode())
        {
            ...
            ISP_IOCTL_WRITE_ENABLE_REG(m_pIspDrv, m_pIspDrv->getRegAddrMap(),  CAM_CTL_EN2_CLR, CQ_CAM_CTL_CAN_BE_CLR_BITS(EN2,this->isIspOn)& \
                CQ_CAM_CTL_BIT_FIXED(EN2,NR3D,this->isEn2Nr3dStatusFixed) & \
            ...
            //
            ISP_IOCTL_WRITE_REG(m_pIspDrv, m_pIspDrv->getRegAddrMap(),  CAM_CTL_MUX_SEL2_CLR, (this->isIspOn?(~0xBF67E083):0) & (~ctl_mux_sel2.reg_val));
            //
            ...
            ISP_FUNC_INF("[Pass1]EN1-Set(0x%x),Clr(0x%x)-En2:Set(0x%x),Clr(0x%x)-DMA:Set(0x%x),Clr(0x%x)\n", \
        ...
        else
        {
            ...
            //
            ISP_WRITE_REG(m_pIspReg,  CAM_CTL_MUX_SEL2_CLR, (this->isIspOn?(~0xBF67E083):0) & (~ctl_mux_sel2.reg_val));
            //
        ...
        if (m_pIspDrv->IsReadOnlyMode())
        {
            ...
            ISP_FUNC_DBG("[Pass2]AppTurn(%d),EN1:Set(0x%08x),Clr(0x%08x),En2:Set(0x%08x),Clr(0x%08x),DMA:Set(0x%08x),Clr(0x%08x)\n", \
                    applyTurn,
                    ISP_IOCTL_READ_REG(m_pIspDrv, m_pIspDrv->getRegAddrMap(), CAM_CTL_EN1_SET), ISP_IOCTL_READ_REG(m_pIspDrv, m_pIspDrv->getRegAddrMap(),  CAM_CTL_EN1_CLR), \
                    ISP_IOCTL_READ_REG(m_pIspDrv, m_pIspDrv->getRegAddrMap(), CAM_CTL_EN2_SET), ISP_IOCTL_READ_REG(m_pIspDrv, m_pIspDrv->getRegAddrMap(),  CAM_CTL_EN2_CLR), \
                    ISP_IOCTL_READ_REG(m_pIspDrv, m_pIspDrv->getRegAddrMap(), CAM_CTL_DMA_EN_SET),ISP_IOCTL_READ_REG(m_pIspDrv, m_pIspDrv->getRegAddrMap(),  CAM_CTL_DMA_EN_CLR));
    ...
    ISP_FUNC_DBG("[Fixed][En2]Cdrz(%d),G2C(%d),C42(%d),Nr3d(%d)",this->isEn2CdrzStatusFixed,this->isEn2G2cStatusFixed,this->isEn2C42StatusFixed,this->isEn2Nr3dStatusFixed);
...
if (this->m_pIspDrvShell->m_pIMemDrv)    // If this->m_pIspDrvShell->m_pIMemDrv not null (i.e. not GDMA mode). // No IMem in GDMA mode so don't have to flush.
{
    ...
    if ( CAM_ISP_PASS1_START == (*start) ) {
        ...
        if(m_pPhyIspDrv->IsReadOnlyMode())
        {
            ISP_IOCTL_WRITE_ENABLE_REG(m_pPhyIspDrv, m_pPhyIspDrv->getRegAddrMap(),  CAM_CTL_START, 0x00000001);  // PASS2_START
        }
        else
        {
            ISP_WRITE_ENABLE_REG(m_pPhyIspReg,  CAM_CTL_START, 0x00000001);
        }
    }
        ...
        if(m_pPhyIspDrv->IsReadOnlyMode())
        {
            ISP_IOCTL_WRITE_ENABLE_REG(m_pPhyIspDrv, m_pPhyIspDrv->getRegAddrMap(),  CAM_CTL_START, 0x00000002);  // PASS2B_START
        }
        else
        {
            ISP_WRITE_ENABLE_REG(m_pPhyIspReg,  CAM_CTL_START, 0x00000002);
        }
    }
        ...
        if(m_pPhyIspDrv->IsReadOnlyMode())
        {
            ISP_IOCTL_WRITE_ENABLE_REG(m_pPhyIspDrv, m_pPhyIspDrv->getRegAddrMap(),  CAM_CTL_START, 0x00000010);  // PASS2C_START
        }
        else
        {
            ISP_WRITE_ENABLE_REG(m_pPhyIspReg,  CAM_CTL_START, 0x00000010);
        }
    }
    ...
    ISP_FUNC_INF("path(%d),start(%d),SCIO(%d),En1(0x%x),En2(0x%x),Dma(0x%x),CQ_status(0x%x),CQ_debugset(%d)",
    this->path, \
    *((MUINT32*)pParam), \
    ...
    this->m_pIspDrvShell->getPhyIspDrv()->readReg(0x0000400C),CQ_status,CQ_debugset);
...
int ISP_TOP_CTRL::_disable( void )
{
    ...
    if (ISP_PASS1 == this->path) {
        ...
        // double check for pass1 (hardware is sync vsync signal)
        if(m_pPhyIspDrv->IsReadOnlyMode()){
        ...
        if(m_pPhyIspDrv->IsReadOnlyMode())
        {
            ISP_IOCTL_WRITE_ENABLE_REG(m_pPhyIspDrv, m_pPhyIspDrv->getRegAddrMap(),  CAM_CTL_START, 0x00000000);  // PASS2_START
            //
            // VIDO should be inactive
            ISP_IOCTL_WRITE_ENABLE_BITS(m_pPhyIspDrv, m_pPhyIspDrv->getRegAddrMap(), CAM_CTL_DMA_EN_CLR, VIDO_EN_CLR, 1);
        }
        else
        {
            ISP_WRITE_ENABLE_REG(m_pPhyIspReg,  CAM_CTL_START, 0x00000000);
            //
            // VIDO should be inactive
            ISP_WRITE_ENABLE_BITS(this->m_pPhyIspReg, CAM_CTL_DMA_EN_CLR, VIDO_EN_CLR, 1);
        }
    }
    else if (ISP_PASS2B == this->path) {
        if(m_pPhyIspDrv->IsReadOnlyMode())
        {
            ISP_IOCTL_WRITE_ENABLE_REG(m_pPhyIspDrv, m_pPhyIspDrv->getRegAddrMap(),  CAM_CTL_START, 0x00000000);  // PASS2B_START
        }
        else
        {
            ISP_WRITE_ENABLE_REG(m_pPhyIspReg,  CAM_CTL_START, 0x00000000);
        ...
        if(m_pPhyIspDrv->IsReadOnlyMode())
        {
            ISP_IOCTL_WRITE_ENABLE_REG(m_pPhyIspDrv, m_pPhyIspDrv->getRegAddrMap(),  CAM_CTL_START, 0x00000000);  // PASS2C_START
        }
        else
        {
            ISP_WRITE_ENABLE_REG(m_pPhyIspReg,  CAM_CTL_START, 0x00000000);
    ...
    for ( int rt_dma =_imgi_; rt_dma < _rt_dma_max_ ;rt_dma++ ) {
        //
            ...
            if ( ISP_PASS1 == this->path ) {
            if ( (_imgo_!=rt_dma) && (_img2o_!=rt_dma) ) {continue;}
            }
            else {
            if ( (_imgo_==rt_dma) || (_img2o_==rt_dma) ) {continue;}
            }
...
#if defined(USING_MTK_LDVT)
    //debug path, imagio will config all engine by CQ
    #define CAM_ISP_RGB_MODULE_COUNT    6
    struct stCam_Id_Enable cq_info[CAM_ISP_RGB_MODULE_COUNT] = { \
                                         {CAM_ISP_MFB,  CAM_CTL_EN1_MFB_EN}, \
                                         {CAM_ISP_C02,  CAM_CTL_EN1_C02_EN}, \
                                         {CAM_ISP_CFA,  CAM_CTL_EN1_CFA_EN}, \
                                         {CAM_ISP_CCL,  CAM_CTL_EN1_CCL_EN}, \
                                         {CAM_ISP_G2G,  CAM_CTL_EN1_G2G_EN}, \
                                         {CAM_ISP_LCE_BASIC_1,  CAM_CTL_EN1_LCE_EN}, \
                                         };
#else
    //MP path, do not config engine by imageio
...
MBOOL cdp_result = MTRUE;
    ...
    if ( this->conf_rotDMA ) {
        ...
        if ( CAM_CTL_DMA_EN_VIDO_EN&this->dma_enable ) {
            ...
            cdp_result = \
            this->m_pIspDrvShell->m_pCdpDrv->VIDO_Config(
                rotDMA_ImgSize,
                rotDMA_Crop,
            ...
            if(this->vido_out.memBuf.base_pAddr) {
                cdp_result = \
                this->m_pIspDrvShell->m_pCdpDrv->VIDO_SetOutputAddr(
                    this->vido_out.memBuf.base_pAddr,
        ...
        if ( CAM_CTL_DMA_EN_DISPO_EN&this->dma_enable ) {
            ...
            cdp_result = \
            this->m_pIspDrvShell->m_pCdpDrv->DISPO_Config(
                rotDMA_ImgSize,
                rotDMA_Crop,
            ...
            if(this->dispo_out.memBuf.base_pAddr) {
                cdp_result = \
                this->m_pIspDrvShell->m_pCdpDrv->DISPO_SetOutputAddr(
                    this->dispo_out.memBuf.base_pAddr,
...
int CAM_TDRI_PIPE::_config( void )
{
    ...
    if ( this->enTdri ) {
        ...
        if (MFALSE == tdri_result) {
            ISP_FUNC_ERR("[Error]configTdriPara");
            return -1;
        }
    }
...
MINT32
ISP_BUF_CTRL::
enqueueHwBuf( MUINT32 dmaChannel, stISP_BUF_INFO bufInfo )
{
    MINT32 rt_dma = getDmaBufIdx(dmaChannel);
    MUINT32 end = 0;
...
dequeueHwBuf( MUINT32 dmaChannel )
{
    ...
    if ( ISP_PASS1 == this->path ) {
        ...
        //pass2
        while(count--) {
            if (m_hwbufL[rt_dma].bufInfoList.size()) {
                //change type
