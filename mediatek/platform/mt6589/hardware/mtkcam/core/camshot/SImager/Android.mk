...
LOCAL_SRC_FILES += $(call all-c-cpp-files-under, ImageTransform)
LOCAL_SRC_FILES += $(call all-c-cpp-files-under, JpegCodec)
...
#-----------------------------------------------------------
#LOCAL_WHOLE_STATIC_LIBRARIES += libJpgEnc_pipe
#LOCAL_WHOLE_STATIC_LIBRARIES += libJpgEncPipe
