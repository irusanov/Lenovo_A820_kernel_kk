...
LOCAL_SRC_FILES += $(call all-c-cpp-files-under, SamplePipe)
LOCAL_SRC_FILES += $(call all-c-cpp-files-under, utils)
...
#-----------------------------------------------------------
LOCAL_WHOLE_STATIC_LIBRARIES += libcampipe_plat_pipe_mgr
#
LOCAL_STATIC_LIBRARIES += 

#-----------------------------------------------------------
LOCAL_SHARED_LIBRARIES += liblog libcutils libstlport
LOCAL_SHARED_LIBRARIES += libimageio libcamdrv
