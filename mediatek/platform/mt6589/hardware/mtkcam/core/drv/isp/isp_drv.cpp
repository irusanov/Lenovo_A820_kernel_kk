...
#define LOG_CQ_VIRTUAL_TABLE(_cq_,_idx_,_num_) \
{   \
    switch(_num_) {   \
        case 1: \
            LOG_INF("0x%08x",mpIspVirRegAddrVA[_cq_][mIspCQModuleInfo[_idx_].addr_ofst >>2]);   \
            break;  \
        case 2: \
            LOG_INF("0x%08x-0x%08x",mpIspVirRegAddrVA[_cq_][mIspCQModuleInfo[_idx_].addr_ofst >>2], \
                mpIspVirRegAddrVA[_cq_][(mIspCQModuleInfo[_idx_].addr_ofst>>2)+1]); \
            break;  \
        case 3: \
            LOG_INF("0x%08x-0x%08x-0x%08x",mpIspVirRegAddrVA[_cq_][mIspCQModuleInfo[_idx_].addr_ofst >>2],  \
                mpIspVirRegAddrVA[_cq_][(mIspCQModuleInfo[_idx_].addr_ofst>>2)+1],  \
                mpIspVirRegAddrVA[_cq_][(mIspCQModuleInfo[_idx_].addr_ofst>>2)+2]); \
            break;  \
        case 4: \
            LOG_INF("0x%08x-0x%08x-0x%08x-0x%08x",mpIspVirRegAddrVA[_cq_][mIspCQModuleInfo[_idx_].addr_ofst >>2],   \
                mpIspVirRegAddrVA[_cq_][(mIspCQModuleInfo[_idx_].addr_ofst>>2)+1],  \
                mpIspVirRegAddrVA[_cq_][(mIspCQModuleInfo[_idx_].addr_ofst>>2)+2],  \
                mpIspVirRegAddrVA[_cq_][(mIspCQModuleInfo[_idx_].addr_ofst>>2)+3]); \
            break;  \
        case 5: \
            LOG_INF("0x%08x-0x%08x-0x%08x-0x%08x-0x%08x",mpIspVirRegAddrVA[_cq_][mIspCQModuleInfo[_idx_].addr_ofst >>2],    \
                mpIspVirRegAddrVA[_cq_][(mIspCQModuleInfo[_idx_].addr_ofst>>2)+1],  \
                mpIspVirRegAddrVA[_cq_][(mIspCQModuleInfo[_idx_].addr_ofst>>2)+2],  \
                mpIspVirRegAddrVA[_cq_][(mIspCQModuleInfo[_idx_].addr_ofst>>2)+3],  \
                mpIspVirRegAddrVA[_cq_][(mIspCQModuleInfo[_idx_].addr_ofst>>2)+4]); \
            break;  \
        case 6: \
            LOG_INF("0x%08x-0x%08x-0x%08x-0x%08x-0x%08x-0x%08x",mpIspVirRegAddrVA[_cq_][mIspCQModuleInfo[_idx_].addr_ofst >>2], \
                mpIspVirRegAddrVA[_cq_][(mIspCQModuleInfo[_idx_].addr_ofst>>2)+1],  \
                mpIspVirRegAddrVA[_cq_][(mIspCQModuleInfo[_idx_].addr_ofst>>2)+2],  \
                mpIspVirRegAddrVA[_cq_][(mIspCQModuleInfo[_idx_].addr_ofst>>2)+3],  \
                mpIspVirRegAddrVA[_cq_][(mIspCQModuleInfo[_idx_].addr_ofst>>2)+4],  \
                mpIspVirRegAddrVA[_cq_][(mIspCQModuleInfo[_idx_].addr_ofst>>2)+5]); \
            break;  \
        case 7: \
            LOG_INF("0x%08x-0x%08x-0x%08x-0x%08x-0x%08x-0x%08x-0x%08x",mpIspVirRegAddrVA[_cq_][mIspCQModuleInfo[_idx_].addr_ofst >>2],  \
                mpIspVirRegAddrVA[_cq_][(mIspCQModuleInfo[_idx_].addr_ofst>>2)+1],  \
                mpIspVirRegAddrVA[_cq_][(mIspCQModuleInfo[_idx_].addr_ofst>>2)+2],  \
                mpIspVirRegAddrVA[_cq_][(mIspCQModuleInfo[_idx_].addr_ofst>>2)+3],  \
                mpIspVirRegAddrVA[_cq_][(mIspCQModuleInfo[_idx_].addr_ofst>>2)+4],  \
                mpIspVirRegAddrVA[_cq_][(mIspCQModuleInfo[_idx_].addr_ofst>>2)+5],  \
                mpIspVirRegAddrVA[_cq_][(mIspCQModuleInfo[_idx_].addr_ofst>>2)+6]); \
            break;  \
        case 8: \
            LOG_INF("0x%08x-0x%08x-0x%08x-0x%08x-0x%08x-0x%08x-0x%08x-0x%08x",mpIspVirRegAddrVA[_cq_][mIspCQModuleInfo[_idx_].addr_ofst >>2],   \
                mpIspVirRegAddrVA[_cq_][(mIspCQModuleInfo[_idx_].addr_ofst>>2)+1],  \
                mpIspVirRegAddrVA[_cq_][(mIspCQModuleInfo[_idx_].addr_ofst>>2)+2],  \
                mpIspVirRegAddrVA[_cq_][(mIspCQModuleInfo[_idx_].addr_ofst>>2)+3],  \
                mpIspVirRegAddrVA[_cq_][(mIspCQModuleInfo[_idx_].addr_ofst>>2)+4],  \
                mpIspVirRegAddrVA[_cq_][(mIspCQModuleInfo[_idx_].addr_ofst>>2)+5],  \
                mpIspVirRegAddrVA[_cq_][(mIspCQModuleInfo[_idx_].addr_ofst>>2)+6],  \
                mpIspVirRegAddrVA[_cq_][(mIspCQModuleInfo[_idx_].addr_ofst>>2)+7]); \
            break;  \
        case 9: \
            LOG_INF("0x%08x-0x%08x-0x%08x-0x%08x-0x%08x-0x%08x-0x%08x-0x%08x-0x%08x",mpIspVirRegAddrVA[_cq_][mIspCQModuleInfo[_idx_].addr_ofst >>2],   \
                mpIspVirRegAddrVA[_cq_][(mIspCQModuleInfo[_idx_].addr_ofst>>2)+1],  \
                mpIspVirRegAddrVA[_cq_][(mIspCQModuleInfo[_idx_].addr_ofst>>2)+2],  \
                mpIspVirRegAddrVA[_cq_][(mIspCQModuleInfo[_idx_].addr_ofst>>2)+3],  \
                mpIspVirRegAddrVA[_cq_][(mIspCQModuleInfo[_idx_].addr_ofst>>2)+4],  \
                ...
                mpIspVirRegAddrVA[_cq_][(mIspCQModuleInfo[_idx_].addr_ofst>>2)+6],  \
                mpIspVirRegAddrVA[_cq_][(mIspCQModuleInfo[_idx_].addr_ofst>>2)+7],  \
                mpIspVirRegAddrVA[_cq_][(mIspCQModuleInfo[_idx_].addr_ofst>>2)+8]); \
            break;  \
        case 10: \
        default:    \
            LOG_INF("0x%08x-0x%08x-0x%08x-0x%08x-0x%08x-0x%08x-0x%08x-0x%08x-0x%08x-0x%08x",mpIspVirRegAddrVA[_cq_][mIspCQModuleInfo[_idx_].addr_ofst >>2],   \
                mpIspVirRegAddrVA[_cq_][(mIspCQModuleInfo[_idx_].addr_ofst>>2)+1],  \
                mpIspVirRegAddrVA[_cq_][(mIspCQModuleInfo[_idx_].addr_ofst>>2)+2],  \
                mpIspVirRegAddrVA[_cq_][(mIspCQModuleInfo[_idx_].addr_ofst>>2)+3],  \
                mpIspVirRegAddrVA[_cq_][(mIspCQModuleInfo[_idx_].addr_ofst>>2)+4],  \
                ...
                mpIspVirRegAddrVA[_cq_][(mIspCQModuleInfo[_idx_].addr_ofst>>2)+7],  \
                mpIspVirRegAddrVA[_cq_][(mIspCQModuleInfo[_idx_].addr_ofst>>2)+8],  \
                mpIspVirRegAddrVA[_cq_][(mIspCQModuleInfo[_idx_].addr_ofst>>2)+9]); \
            break;  \
    }   \
}
...
#define ISP_INT_BIT_NUM                 32
    ...
    ISP_DRV_TURNING_TOP mIspDrvTurningTop[ISP_DRV_TURNING_TOP_NUM]
    ...
    ISP_DRV_CQ_MAPPING mIspDrvCqMappinig[ISP_DRV_CQ_NUM]
    =   {
...
//          {ISP_DRV_CQ03,        ISP_DRV_DESCRIPTOR_CQ03},
        ...
        =   {
              ...
              {CAM_ISP_C02,               0x4950, 1  },
              {CAM_ISP_MFB,               0x4960, 3  },
              {CAM_ISP_LCE_BASIC_1,       0x49C0, 2  },
              {CAM_ISP_LCE_CUSTOM,        0x49C8, 2  },
              {CAM_ISP_LCE_BASIC_2,       0x49D0, 9  },
              {CAM_ISP_G2C,               0x4A00, 6  },
              {CAM_ISP_C42,               0x4A1C, 1  },
              {CAM_ISP_NBC,               0x4A20, 32 },
              {CAM_ISP_SEEE,              0x4AA0, 24 },
              {CAM_CDP_CDRZ,              0x4B00, 15 },
              {CAM_CDP_CURZ,              0x4B40, 15 },
              {CAM_CDP_PRZ,               0x4BA0, 15 },
              {CAM_CDP_FE,                0x4C20, 4  },
              {CAM_CDP_VIDO,              0x4CC0, 30 },
              {CAM_CDP_DISPO,             0x4D40, 30 },
              {CAM_ISP_EIS,               0x4DC0, 9  },
              {CAM_ISP_DGM,               0x4E30, 6  },
              {CAM_GDMA_FMT,              0x4E50, 36 },
              {CAM_CDP_G2G2,              0x4EE0, 7  },
              {CAM_CDP_3DNR,              0x4F00, 15 },
              {CAM_ISP_GGMRB,             0x5000, 144},
              {CAM_ISP_GGMG,              0x5300, 144},
              {CAM_ISP_GGM_CTL,           0x5600, 1  },
              {CAM_ISP_PCA,               0x5800, 360},
              {CAM_ISP_PCA_CON,           0x5E00, 2  },
              {CAM_DUMMY_,                0x4600, 1  }};  // dummy address
    ...
    ISP_DRV_CQ_BIT_3GP_MAPPING gIspTurnEn1Mapp[ISP_INT_BIT_NUM]
        = { {CAM_DUMMY_,          CAM_DUMMY_,         CAM_DUMMY_},          // bit 0
            ...
            {CAM_DUMMY_,          CAM_DUMMY_,         CAM_DUMMY_},          // bit 8
            ...
            {CAM_ISP_DGM,         CAM_DUMMY_,         CAM_DUMMY_},          // bit 24
            {CAM_ISP_LCE_BASIC_1, CAM_ISP_LCE_CUSTOM, CAM_ISP_LCE_BASIC_2}, // bit 25
...
//-----------------------------------------------------------------------------
IspDrv* IspDrv::createInstance(bool fgIsGdmaMode)
{
...
{
    int cmd;
    LOG_VRB("- E. isp_cq[0x%x],descri_cq[0x%x],[%d]",cq,mIspDrvCqMappinig[cq].descriptorCq,moduleId);
    //
    ...
    mpIspCQDescriptorVirt[mIspDrvCqMappinig[cq].descriptorCq][moduleId].v_reg_addr = (MUINT32)&mpIspVirRegAddrPA[cq][mIspCQModuleInfo[moduleId].addr_ofst >>2 ]; // >>2 for MUINT32* pointer
    mpIspCQDescriptorVirt[mIspDrvCqMappinig[cq].descriptorCq][moduleId].u.cmd = cmd;
	//
	LOG_VRB("- X.");
    return MTRUE;
}
...
MBOOL IspDrv::cqDelModule(ISP_DRV_CQ_ENUM cq, CAM_MODULE_ENUM moduleId)
{
    ...
    //
    Mutex::Autolock lock(cqVirDesLock);
	mpIspCQDescriptorVirt[mIspDrvCqMappinig[cq].descriptorCq][moduleId].u.cmd = ISP_DRV_CQ_DUMMY_WR_TOKEN;
    //
	LOG_VRB("- X.");
    return MTRUE;
}
...
MUINT32 IspDrv::getCQDescBufPhyAddr(ISP_DRV_CQ_ENUM cq)
{
    ...
    return (MUINT32)mpIspCQDescriptorPhy[mIspDrvCqMappinig[cq].descriptorCq];
}
//-----------------------------------------------------------------------------
...
)
{
    ...
    LOG_DBG(" - E. [%s], cq: %d, mode: %d, trig_src: %d.",__FUNCTION__, cq, mode, trig_src);
    switch(cq) {
        case ISP_DRV_CQ0:
        ...
        case ISP_DRV_CQ0B:
            ...
            if ( CQ_TRIG_BY_PASS1_DONE!=trig_src && CQ_TRIG_BY_IMGO_DONE!=trig_src)  {
                LOG_ERR("[%s][ISP_DRV_CQ0B]:NOT Support trigger source \n",__FUNCTION__);
            }
...
MBOOL IspDrv::flushTurnCqTable(int cq)
{
    if(cq == ISP_DRV_CQ01) {
...
MBOOL IspDrv::setTurnTopEn1(int cq, int en1)
{
    int i;
    ...
    if(cq == ISP_DRV_CQ01) {
        ...
        LOG_DBG("KeepEn1(0x%x),preEn1(0x%x)",tdriMgrInfoCq2.topCtlEn1Keep,tdriMgrInfoCq2.topCtlEn1PrevKeep);
...
MBOOL IspDrv::setTurnTopEn2(int cq, int en2)
{
    int i;
    LOG_DBG("cq(%d) en2(0x%x)E\n",cq,en2);
...
MBOOL IspDrv::setTurnTopDma(int cq, int dma)
{
    int i;
    LOG_DBG("cq(%d) dma(0x%x)E\n",cq,dma);
...
MUINT32 IspDrv::getTurnTopEn1(int cq)
{
    LOG_DBG("E,cq(%d).", cq);
...
MUINT32 IspDrv::getTurnTopEn2(int cq)
{
    LOG_DBG(" - E. cq(%d).", cq);
...
MUINT32 IspDrv::getTurnTopDma(int cq)
{
    LOG_DBG(" - E. cq(%d).", cq);
    ...
    if(tdriMgrInfoCq1.updateCqDescriptorNum) {
        ...
        for(i = 0; i < CAM_MODULE_MAX; i++) {
            if(tdriMgrInfoCq1.mTurUpdTable[i] == MTRUE) {
                ...
                cqDescOffset = mIspCQModuleInfo[i].addr_ofst;
                cqDescRegNum = mIspCQModuleInfo[i].reg_num;
                ...
                LOG_DBG("i(%d) cqDescOffset(0x%x) cqDescRegNum(%d) pSrc(0x%x) pDst(0x%x)"
                                ,i,cqDescOffset,cqDescRegNum,(unsigned int)pSrc,(unsigned int)pDst);    //Vent@20121107: Fix build warning: format '%x' expects argument of type 'unsigned int', but argument 8/9 has type 'MUINT32* {aka unsigned int*}' [-Wformat].
                ...
                for(j=0; j<cnt; j++){
                    LOG_VRB("(%d)-src(0x%08X)-dst(0x%08X)",j,*(pSrc+j),*(pDst+j));
                }
        ...
        LOG_DBG("topCtlEn1(0x%x)\n",tdriMgrInfoCq1.topCtlEn1);
        ...
        LOG_DBG("topCtlEn2(0x%x)\n",tdriMgrInfoCq1.topCtlEn2);
...
{
    LOG_INF("updateCqdes(%d) CtlEn1(0x%x) CtlEn2(0x%x) CtlMma(0x%x)\n",tdriMgrInfoCq2.updateCqDescriptorNum,
...
void IspDrv::lockSemaphoreCq2()
{

    pthread_mutex_lock(&tdriMgrMutexCq2);
}

void IspDrv::unlockSemaphoreCq1()
{
    LOG_DBG("unlock");
...
void IspDrv::unlockSemaphoreCq2()
{
    pthread_mutex_unlock(&tdriMgrMutexCq2);
}
...
IspDrv* IspDrvImp::getInstance(bool fgIsGdmaMode)
{
//    LOG_DBG("singleton[0x%08x]", (int)&singleton);
    LOG_DBG("singleton[0x%08x]. fgIsGdmaMode: %d.", (int)&singleton, fgIsGdmaMode);
...
MBOOL IspDrvImp::init(void)
{
    ...
    //
    LOG_INF(" - E. mInitCount(%d). m_fgIsGdmaMode: %d.", mInitCount, (int)m_fgIsGdmaMode);
    //
    if(mInitCount > 0)
    {
    ...
    if (!m_fgIsGdmaMode)    // Normal Mode
    {
        ...
        LOG_DBG("[m_pIMemDrv]:0x%08x", (unsigned int)m_pIMemDrv);    //Vent@20121107: Fix build warning: format '%x' expects argument of type 'unsigned int', but argument 5 has type 'IMemDrv*' [-Wformat]
        if ( NULL == m_pIMemDrv ) {
        ...
        LOG_VRB("v(0x%x)(0x%x)(0x%x)(0x%x)(0x%x)(0x%x)",mIspVirRegSize,m_ispVirRegBufInfo.size, \
                                                        ...
                                                        mpIspVirRegBuffer,mpIspVirRegAddrPA[0]);
        ...
        LOG_VRB("cq(0x%x)(0x%x)(0x%x)(0x%x)(0x%x)(0x%x)",mIspCQDescSize,m_ispCQDescBufInfo.size, \
        ...
        for (int i = 0; i < CAM_MODULE_MAX; i++) {
          mIspCQDescInit[i].v_reg_addr = (MUINT32)( mpIspVirRegAddrPA[0] + (0x4060/4) );
        }
        //
        for (int i = 0; i < ISP_DRV_DESCRIPTOR_CQ_NUM; i++)
        {
            if ( 0 == i ) {
...
MBOOL IspDrvImp::waitIrq(ISP_DRV_WAIT_IRQ_STRUCT waitIrq)
{
    MINT32 Ret;
    //
    LOG_DBG(" - E. Clear(%d),Type(%d),Status(0x%08x),Timeout(%d).", waitIrq.Clear, waitIrq.Type, waitIrq.Status, waitIrq.Timeout);
    //
    Ret = ioctl(mFd,ISP_WAIT_IRQ,&waitIrq);
    if((!m_fgIsGdmaMode)&&(Ret<0 || MTRUE==isp_drv_DbgLogEnable_DEBUG)){
        int i;
        ...
        if(waitIrq.Type==0 && waitIrq.Status==0x4000){
            for(i=0;i<=CAM_ISP_PCA_CON;i++){
                if(mpIspCQDescriptorVirt[ISP_DRV_DESCRIPTOR_CQ0][i].u.cmd != 0x4060) {
                    LOG_INF("[CQ0]:[%02d][0x%08x]",i,mpIspCQDescriptorVirt[ISP_DRV_DESCRIPTOR_CQ0][i].u.cmd);

                    LOG_CQ_VIRTUAL_TABLE(ISP_DRV_DESCRIPTOR_CQ0,i,mIspCQModuleInfo[i].reg_num);
                }
            }

            for(i=0;i<=CAM_ISP_PCA_CON;i++){
                if(mpIspCQDescriptorVirt[ISP_DRV_DESCRIPTOR_CQ01][i].u.cmd != 0x4060) {
                    LOG_INF("[CQ1]:[%02d][0x%08x]",i,mpIspCQDescriptorVirt[ISP_DRV_DESCRIPTOR_CQ01][i].u.cmd);
                    LOG_CQ_VIRTUAL_TABLE(ISP_DRV_DESCRIPTOR_CQ01,i,mIspCQModuleInfo[i].reg_num);
                }
            }
            //check tpipe load size
            int val;
            //
            for(i=0x9000;i<=0x900e;i++){
                val = i;
                writeReg(0x4160,val);
                LOG_INF("(0x4160=0x%x)->(0x4164=0x%x)",val,readReg(0x4164));
            }
            LOG_INF("(0x4044=0x%x)(0x4048=0x%x)",readReg(0x4044),readReg(0x4048));
            //
            val = 0x6000;
            writeReg(0x4160,val);
            LOG_INF("CQ status:(0x4160=0x%x)->(0x4164=0x%x)",val,readReg(0x4164));
            //
            val = 0x5000;
            writeReg(0x4160,val);
            LOG_INF("TpipeLoadSize:(0x4160=0x%x)->(0x4164=0x%x)",val,readReg(0x4164));
        ...
        if(waitIrq.Type==2 && waitIrq.Status==0x4000){
            ...
            for(i=0;i<=CAM_ISP_PCA_CON;i++){
                if(mpIspCQDescriptorVirt[ISP_DRV_DESCRIPTOR_CQ01][i].u.cmd != 0x4060) {
                    LOG_INF("[CQ2]:[%02d][0x%08x]",i,mpIspCQDescriptorVirt[ISP_DRV_DESCRIPTOR_CQ02][i].u.cmd);
                    LOG_CQ_VIRTUAL_TABLE(ISP_DRV_DESCRIPTOR_CQ01,i,mIspCQModuleInfo[i].reg_num);
                }
            }
        }
...
//-----------------------------------------------------------------------------
MBOOL IspDrvImp::IsReadOnlyMode(void)
{
#if ISP_DRV_MMAP_TO_IOCLT_ENABLE
    return MTRUE;
#else
...
MUINT32 IspDrvImp::GlobalPipeCountInc(void)
{
    LOG_INF("- E.");
    ...
    LOG_INF("- X. Result: %d. count: %d.", Result, count);
...
MUINT32 IspDrvImp::GlobalPipeCountDec(void)
{
    LOG_INF("- E.");
...
MBOOL IspDrvImp::cqRingBuf(void *pBuf_ctrl)
{
   MINT32 Ret;
    ...
    //
    LOG_DBG("[rtbc]pcqrtbcring_va(0x%08x) \n",pcqrtbcring_va);
    LOG_DBG("[rtbc]pcqrtbcring_pa(0x%08x) \n",pcqrtbcring_pa);
    LOG_DBG("[rtbc]ctrl(%d),dma(%d),PA(0x%x),or_size(%d),2or_size(%d)", \
            pbuf_ctrl->ctrl, \
            pbuf_ctrl->buf_id, \
        ...
        case ISP_RT_BUF_CTRL_ENQUE:
            ...
            if ( 0 == ((reg_val & 0x01) | (reg_val2 & 0x01)) ) {
                ...
                pcqrtbcring_va->rtbc_ring[i].next_pa = \
                    (MUINT32)RTBC_GET_PA_FROM_VA(pcqrtbcring_va->rtbc_ring[i].pNext,pcqrtbcring_va,pcqrtbcring_pa);
                //
