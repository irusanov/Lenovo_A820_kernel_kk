...
checkPictureSize()
{
    int32_t i4PictureWidth = 0, i4PictureHeight = 0, i4Rotation = getParamsMgr()->getInt(CameraParameters::KEY_ROTATION);
    int32_t i4PictureWidthRot = 0 , i4PictureHeightRot = 0;
    //
    getParamsMgr()->getPictureSize(&i4PictureWidth, &i4PictureHeight);
    //
    if(i4Rotation == 90 || i4Rotation == 270)
    {
        i4PictureWidthRot = i4PictureHeight;
        i4PictureHeightRot = i4PictureWidth;
    }
    else
    {
        i4PictureWidthRot = i4PictureWidth;
        i4PictureHeightRot = i4PictureHeight;
    }
    //
    if( mPorts.pass2YuvOut.u4Width != i4PictureWidthRot ||
        mPorts.pass2YuvOut.u4Height != i4PictureHeightRot)
    {
        MY_LOGW("Pic size change %dx%d(%d) -> %dx%d(%d)",
                mPorts.pass2YuvOut.u4Width,
                mPorts.pass2YuvOut.u4Height,
                mPorts.pass2YuvOut.eRotate,
                i4PictureWidthRot,
                ...
                i4Rotation);
        //
        mPorts.pass2YuvOut.u4Width = i4PictureWidthRot;
        mPorts.pass2YuvOut.u4Height = i4PictureHeightRot;
        mspCaptureBufHandler->resetBuffer();
    }
    //
    return true;
}
...
/*
    ...
    */
    ...
    if (flag & eID_Pass2VIDO)
    {
        ...
        //mspPreviewBufHandler->enqueBuffer(vidoNode);
        capNode.u4FocusValH = 0; // Fix me
        capNode.u4FocusValL = 0; // Fix me
