...
public:
    ...
    //!
    /////////////////////////////////////////////////////////////////////////
    MRESULT mrCalLinearityC(INT32 a_i4Expline,
                                INT32 a_i4ExpTimes,
                                INT32 a_i4Iris,
                                INT32 a_i4PreCap,
                                RAWAnalyzeResult *a_pResult);
    ...
    int flashCalibration();
    MBOOL GetShadingRaw(eCAMERA_MODE mode, UINT8 ColorTemp);
...
private:
    ...
    ACDK_CDVT_SENSOR_CALIBRATION_OUTPUT_T m_SensorCaliData;
