...
#define CCCI1_DRIVER_VER 		0x20130606
#define CCCI2_DRIVER_VER 		0x20130606
#else
...
// #define CCIF_BASE			(AP_CCIF0_BASE)
...
/* Modem CCIF */
// #define MD_CCIF0_BASE			(AP_CCIF0_BASE)
