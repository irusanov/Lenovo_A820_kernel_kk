...
void SMI_Init(void)
{
	u4SMILarbBaseAddr[0] = SMI_LARB0;
	u4SMILarbBaseAddr[1] = SMI_LARB1;
	u4SMILarbBaseAddr[2] = SMI_LARB2;
	u4SMILarbBaseAddr[3] = SMI_LARB3;
	u4SMILarbBaseAddr[4] = SMI_LARB4;

	u4SMICommBaseAddr[0] = SMI_COMMON;
}
