...
extern void MET_MCI_Mon_Enable(void);
extern void MET_MCI_Mon_Disable(void);
extern void MET_MCI_Event_Set(unsigned int evt0, unsigned int evt1);
extern void MET_MCI_Event_Read(void);
extern unsigned int MET_MCI_GetEvent(int counter);
extern unsigned int MET_MCI_GetEventCount(int evt_counter);
