...
#define    M4U_CLNTMOD_SZ_VENC        (600*0x00100000)
#define    M4U_CLNTMOD_SZ_VDEC        (600*0x00100000)
#define    M4U_CLNTMOD_SZ_ROT         (600*0x00100000)
#define    M4U_CLNTMOD_SZ_OVL         (600*0x00100000)
#define    M4U_CLNTMOD_SZ_WDMA        (600*0x00100000)
#define    M4U_CLNTMOD_SZ_RDMA        (600*0x00100000)
#define    M4U_CLNTMOD_SZ_CMDQ        (600*0x00100000)
#define    M4U_CLNTMOD_SZ_DBI         (600*0x00100000)
#define    M4U_CLNTMOD_SZ_G2D         (600*0x00100000)
#define    M4U_CLNTMOD_SZ_JPGDEC      (600*0x00100000)
#define    M4U_CLNTMOD_SZ_JPGENC      (600*0x00100000)
#define    M4U_CLNTMOD_SZ_VIP         (600*0x00100000)
#define    M4U_CLNTMOD_SZ_DISP        (600*0x00100000)
#define    M4U_CLNTMOD_SZ_VID         (600*0x00100000)
#define    M4U_CLNTMOD_SZ_GDMA        (600*0x00100000)
#define    M4U_CLNTMOD_SZ_IMG         (600*0x00100000)
#define    M4U_CLNTMOD_SZ_LSCI        (600*0x00100000)
#define    M4U_CLNTMOD_SZ_FLKI        (600*0x00100000)
#define    M4U_CLNTMOD_SZ_LCEI        (600*0x00100000)
#define    M4U_CLNTMOD_SZ_LCSO        (600*0x00100000)
#define    M4U_CLNTMOD_SZ_ESFKO       (600*0x00100000)
#define    M4U_CLNTMOD_SZ_AAO         (600*0x00100000)
#define    M4U_CLNTMOD_SZ_AUDIO       (600*0x00100000)
#define    M4U_CLNTMOD_SZ_LCDC_UI     (600*0x00100000)
#define    M4U_CLNTMOD_SZ_RESERVED    (600*0x00100000)
