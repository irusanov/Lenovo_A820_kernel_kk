...
//lenovo-sw yexh1 2014_01_07 modify: we should not enable otg detection until system boot ready. Refer to VIPER-11300
struct delayed_work  otg_int_work;
void  otg_int_init_work(void)   //xuehui
{
      otg_int_init(); 
}
//lenovo-sw yexh1 2014_01_07 end
...
//lenovo-sw yexh1 2014_01_07 modify: we should not enable otg detection until system boot ready. Refer to VIPER-11300
    //otg_int_init();
    INIT_DELAYED_WORK(&otg_int_work, otg_int_init_work);
    schedule_delayed_work(&otg_int_work, 2000);	
//lenovo-sw yexh1 2014_01_07 end
