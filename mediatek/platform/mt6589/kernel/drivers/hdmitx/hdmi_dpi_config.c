...
void hdmi_dpi_power_enable(bool enable, bool clock_on)
{
    ...
    else if (!enable && clock_on)
    {
        HDMI_DPI(_DisableIrq)();
        HDMI_DPI(_DisableClk)();
        HDMI_DPI(_PowerOff)();

        if (disable_pll(TVDPLL, "HDMI"))
        {
...
void hdmi_dpi_setting_res(u8 arg, HDMI_CABLE_TYPE cable_type, _t_hdmi_context *hdmi_context_unstatic)
{
    switch (arg)
    {
        ...
        case HDMI_VIDEO_720x576p_50Hz:
        {
            ...
            hdmi_context_unstatic->bg_height = ((576 * hdmi_context_unstatic->scaling_factor) / 100 >> 2) << 2 ;
            hdmi_context_unstatic->bg_width = ((720 * hdmi_context_unstatic->scaling_factor) / 100 >> 2) << 2 ;
            hdmi_context_unstatic->hdmi_width = 720 - hdmi_context_unstatic->bg_width;
            hdmi_context_unstatic->hdmi_height = 576 - hdmi_context_unstatic->bg_height;
            hdmi_context_unstatic->output_video_resolution = HDMI_VIDEO_720x576p_50Hz;
            break;
        }
#endif
        case HDMI_VIDEO_1280x720p_60Hz:
...
#endif
            hdmi_context_unstatic->output_video_resolution = HDMI_VIDEO_1280x720p_50Hz;
            break;
        }
        case HDMI_VIDEO_1920x1080p_24Hz:
        {
            ...
            hdmi_context_unstatic->output_video_resolution = HDMI_VIDEO_1920x1080p_24Hz;
            break;
        }
        case HDMI_VIDEO_1920x1080p_25Hz:
        {
            ...
            hdmi_context_unstatic->hdmi_width = 1920 - hdmi_context_unstatic->bg_width;
            hdmi_context_unstatic->hdmi_height = 1080 - hdmi_context_unstatic->bg_height;
            hdmi_context_unstatic->output_video_resolution = HDMI_VIDEO_1920x1080p_25Hz;
            break;
        }
#endif
        case HDMI_VIDEO_1920x1080p_30Hz:
        ...
        case HDMI_VIDEO_1920x1080p_29Hz:
        {
            ...
            hdmi_context_unstatic->hdmi_width = 1920 - hdmi_context_unstatic->bg_width;
            hdmi_context_unstatic->hdmi_height = 1080 - hdmi_context_unstatic->bg_height;
            hdmi_context_unstatic->output_video_resolution = HDMI_VIDEO_1920x1080p_29Hz;
            break;
        }
        case HDMI_VIDEO_1920x1080p_23Hz:
        {
            ...
            hdmi_context_unstatic->hdmi_width = 1920 - hdmi_context_unstatic->bg_width;
            hdmi_context_unstatic->hdmi_height = 1080 - hdmi_context_unstatic->bg_height;
            hdmi_context_unstatic->output_video_resolution = HDMI_VIDEO_1920x1080p_23Hz;
            break;
        }
#endif
        default:
