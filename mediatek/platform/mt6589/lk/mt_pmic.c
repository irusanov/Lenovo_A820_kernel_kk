...
void upmu_set_rg_vbat_cv_vth(U32 val)
{
  ...
  if(g_pmic_cid == 0x1020)
  {
    ...
    {
        printf("[lk_upmu_set_rg_vbat_cv_vth] cannot set %d in 0x1020, need reset to 0x0 \n", val);
...
int pmic_detect_powerkey(void)
{
    ...
    if (val==1){     
        printf("[pmic_detect_powerkey] Release\n");
        return 0;
    }else{
        printf("[pmic_detect_powerkey] Press\n");
        return 1;
    }
}
...
void PMIC_INIT_SETTING_V1(void)
{
    ...
    {
        printf("[LK_PMIC_INIT_SETTING_V1] PMIC Chip = %x\n",chip_version);
        printf("[LK_PMIC_INIT_SETTING_V1] 20121220 (>=2)\n");
    ...
    {
        printf("[LK_PMIC_INIT_SETTING_V1] PMIC Chip = %x\n",chip_version);
        printf("[LK_PMIC_INIT_SETTING_V1] 20121029 (1)\n");
...
U32 pmic6320_init (void)
{
    ...
    printf("[LK_PMIC_INIT] PMIC CID=0x%x\n", g_pmic_cid);
...
int PMIC_IMM_GetOneChannelValue(int dwChannel, int deCount, int trimd)
{
    ...
    */
    ...
    do
    {
        ...
        switch(dwChannel){         
            case 0:    
                ...
                {    
                    ...
                    {
                        printf("[IMM_GetOneChannelValue_PMIC] (%d) Time out!\n", dwChannel);
                        break;
                    }
                }
                if(trimd == 1) {
        ...
        //debug
        printf("[AUXADC] u4Sample_times=%d, ret_data=%d, u4channel[%d]=%d.\n", 
...
/********* Finally setting *******************************/
    ...
    {
        printf("mt_charger_type_detection : SW workaround for USB\r\n");
        //RG_BC11_BB_CTRL=1
        ret_val=pmic_config_interface(CHR_CON18,0x1,PMIC_RG_BC11_BB_CTRL_MASK,PMIC_RG_BC11_BB_CTRL_SHIFT);
        //RG_BC11_BIAS_EN=1
        ret_val=pmic_config_interface(CHR_CON19,0x1,PMIC_RG_BC11_BIAS_EN_MASK,PMIC_RG_BC11_BIAS_EN_SHIFT); 
