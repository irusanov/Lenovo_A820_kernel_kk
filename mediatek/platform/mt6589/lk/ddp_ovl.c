...
int OVLLayerConfig(unsigned int layer,
    ...
    switch(layer) {
        case 0:
            ...
            DISP_REG_SET_FIELD(L0_SRCKEY_FLD_SRCKEY, DISP_REG_OVL_L0_SRCKEY, key);
        ...
        case 1:
            ...
            DISP_REG_SET_FIELD(L1_SRCKEY_FLD_SRCKEY, DISP_REG_OVL_L1_SRCKEY, key);
        ...
        case 2:
            ...
            DISP_REG_SET_FIELD(L2_SRCKEY_FLD_SRCKEY, DISP_REG_OVL_L2_SRCKEY, key);
        ...
        case 3:
            ...
            DISP_REG_SET_FIELD(L3_SRCKEY_FLD_SRCKEY, DISP_REG_OVL_L3_SRCKEY, key);
