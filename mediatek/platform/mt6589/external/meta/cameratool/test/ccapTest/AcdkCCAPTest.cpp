...
MRESULT mrCCAPSingleShot_Cmd(const MUINT32 a_u4Argc, MUINT8 *a_pprArgv[])
{
    ...
    switch(format) {
        ...
        case 1:
            rCCTStillCapConfig.eOutputFormat = OUTPUT_PURE_RAW8;
        ...
        case 3:
            rCCTStillCapConfig.eOutputFormat = OUTPUT_PROCESSED_RAW8;
            ACDK_LOGD("[mrCCAPSingleShot_Cmd] OUTPUT_PROCESSED_RAW8\n");
            break;
        case 4:
            rCCTStillCapConfig.eOutputFormat = OUTPUT_PROCESSED_RAW10;
...
MRESULT mrCCAPMultiShot_Cmd(const MUINT32 a_u4Argc, MUINT8 *a_pprArgv[])
{
    ...
    switch(format) {
        ...
        case 1:
            rCCTMutiShotConfig.eOutputFormat = OUTPUT_PURE_RAW8;
            ACDK_LOGD("[mrCCAPMultiShot_Cmd] OUTPUT_PURE_RAW8\n");
            break;

        case 2:
            rCCTMutiShotConfig.eOutputFormat = OUTPUT_PURE_RAW10;
            ACDK_LOGD("[mrCCAPMultiShot_Cmd] OUTPUT_PURE_RAW10\n");
            break;

        case 3:
            rCCTMutiShotConfig.eOutputFormat = OUTPUT_PROCESSED_RAW8;
            ACDK_LOGD("[mrCCAPMultiShot_Cmd] OUTPUT_PROCESSED_RAW8\n");
            break;
        case 4:
            rCCTMutiShotConfig.eOutputFormat = OUTPUT_PROCESSED_RAW10;
...
MRESULT mrCCAP3ALoadFromNvram_Cmd(const MUINT32 a_u4Argc, MUINT8 *a_pprArgv[])
{
    ...
    BOOL bRet = ::bSendDataToACDK(ACDK_CCT_OP_3A_LOAD_FROM_NVRAM, NULL, 0, NULL, 0, NULL);
...
MRESULT mrCCAPISPGetNvramData_Cmd(const MUINT32 a_u4Argc, MUINT8 *a_pprArgv[])
{
    ...
    ret = ::bSendDataToACDK(ACDK_CCT_V2_OP_ISP_GET_NVRAM_DATA, NULL, 0, (UINT8 *)&nvram_buff, sizeof(ACDK_CCT_NVRAM_SET_STRUCT), &len);
...
MRESULT mrCCAPAWBGetLightProb_Cmd(const MUINT32 a_u4Argc, MUINT8 *a_pprArgv[])
{
    ...
    //! 2. Modify the input data, size, and output data, size
    //! ====================================================
    BOOL bRet = bSendDataToACDK(ACDK_CCT_OP_AWB_GET_LIGHT_PROB,
                                NULL,
                                0,
                                (UINT8 *)&rAWBLightProb,
...
MRESULT mrCCAP_ReadNvram(const MUINT32 a_u4Argc, MUINT8 *a_pprArgv[])
{
    ...
    MUINT32 u4RetLen = 0;
    BOOL bRet = bSendDataToACDK(ACDK_CCT_OP_STROBE_READ_NVRAM,
                                (UINT8*)0,
                                0,
                                (UINT8*)0,
                                0,
...
MRESULT mrCCAP_WriteNvram(const MUINT32 a_u4Argc, MUINT8 *a_pprArgv[])
{
    ...
    MUINT32 u4RetLen = 0;
    BOOL bRet = bSendDataToACDK(ACDK_CCT_OP_STROBE_WRITE_NVRAM,
                                (UINT8*)0,
                                0,
                                (UINT8*)0,
                                0,
...
MRESULT mrCCAP_ReadDefaultNvram(const MUINT32 a_u4Argc, MUINT8 *a_pprArgv[])
{
    ...
    MUINT32 u4RetLen = 0;
    BOOL bRet = bSendDataToACDK(ACDK_CCT_OP_STROBE_READ_DEFAULT_NVRAM,
                                (UINT8*)0,
                                0,
                                (UINT8*)0,
                                0,
...
MRESULT mrCCAP_SetParam(const MUINT32 a_u4Argc, MUINT8 *a_pprArgv[])
{
    ...
    BOOL bRet = bSendDataToACDK(ACDK_CCT_OP_STROBE_SET_PARAM,
                                (UINT8*)p,
                                12,
                                (UINT8*)0,
                                0,
...
MRESULT mrCCAP_GetParam(const MUINT32 a_u4Argc, MUINT8 *a_pprArgv[])
{
    ...
    BOOL bRet = bSendDataToACDK(ACDK_CCT_OP_STROBE_GET_PARAM,
                                (UINT8*)p,
                                8,
                                (UINT8*)out,
                                4,
...
MRESULT mrCCAP_GetNvdata(const MUINT32 a_u4Argc, MUINT8 *a_pprArgv[])
{
    ...
    BOOL bRet = bSendDataToACDK(ACDK_CCT_OP_STROBE_GET_NVDATA,
                                (UINT8*)0,
                                0,
                                (UINT8*)nvdata,
                                CCT_FL_NVDATA_SIZE,
...
MRESULT mrCCAP_SetNvdata(const MUINT32 a_u4Argc, MUINT8 *a_pprArgv[])
{
	...
	char* nvdata;
	nvdata = new char[CCT_FL_NVDATA_SIZE];
    BOOL bRet = bSendDataToACDK(ACDK_CCT_OP_STROBE_SET_NVDATA,
                                (UINT8*)nvdata,
                                CCT_FL_NVDATA_SIZE,
                                (UINT8*)0,
                                0,
...
MRESULT mrCCAP_GetEngY(const MUINT32 a_u4Argc, MUINT8 *a_pprArgv[])
{
    ...
    BOOL bRet = bSendDataToACDK(ACDK_CCT_OP_STROBE_GET_ENG_Y,
    							(UINT8*)0,
                                0,
                                (UINT8*)engY,
...
MRESULT mrCCAP_SetEngY(const MUINT32 a_u4Argc, MUINT8 *a_pprArgv[])
{
	...
	short* engY;
	engY = new short[CCT_FL_ENG_SIZE];
    BOOL bRet = bSendDataToACDK(ACDK_CCT_OP_STROBE_SET_ENG_Y,
    							(UINT8*)engY,
                                CCT_FL_ENG_SIZE*CCT_FL_ENG_UNIT_SIZE,
    							(UINT8*)0,
                                0,
...
MRESULT mrCCAP_GetEngRg(const MUINT32 a_u4Argc, MUINT8 *a_pprArgv[])
{
    ...
    BOOL bRet = bSendDataToACDK(ACDK_CCT_OP_STROBE_GET_ENG_RG,
    							(UINT8*)0,
                                0,
                                (UINT8*)engRg,
                                CCT_FL_ENG_SIZE*CCT_FL_ENG_UNIT_SIZE,
...
MRESULT mrCCAP_SetEngRg(const MUINT32 a_u4Argc, MUINT8 *a_pprArgv[])
{
	...
	short* engRg;
	engRg = new short[CCT_FL_ENG_SIZE];
    BOOL bRet = bSendDataToACDK(ACDK_CCT_OP_STROBE_SET_ENG_RG,
    							(UINT8*)engRg,
                                CCT_FL_ENG_SIZE*CCT_FL_ENG_UNIT_SIZE,
    							(UINT8*)0,
                                0,
...
MRESULT mrCCAP_GetEngBg(const MUINT32 a_u4Argc, MUINT8 *a_pprArgv[])
{
    ...
    BOOL bRet = bSendDataToACDK(ACDK_CCT_OP_STROBE_GET_ENG_BG,
    							(UINT8*)0,
                                0,
                                (UINT8*)engBg,
                                CCT_FL_ENG_SIZE*CCT_FL_ENG_UNIT_SIZE,
...
MRESULT mrCCAP_SetEngBg(const MUINT32 a_u4Argc, MUINT8 *a_pprArgv[])
{
	...
	short* engBg;
	engBg = new short[CCT_FL_ENG_SIZE];
    BOOL bRet = bSendDataToACDK(ACDK_CCT_OP_STROBE_SET_ENG_BG,
    							(UINT8*)engBg,
                                CCT_FL_ENG_SIZE*CCT_FL_ENG_UNIT_SIZE,
    							(UINT8*)0,
                                0,
...
MRESULT mrCCAP_NvdataToFile(const MUINT32 a_u4Argc, MUINT8 *a_pprArgv[])
{
    ...
    BOOL bRet = bSendDataToACDK(ACDK_CCT_OP_STROBE_NVDATA_TO_FILE,
                                (UINT8*)fname,
                                256,
                                (UINT8*)0,
                                0,
...
MRESULT mrCCAP_FileToNvdata(const MUINT32 a_u4Argc, MUINT8 *a_pprArgv[])
{
    ...
    BOOL bRet = bSendDataToACDK(ACDK_CCT_OP_STROBE_FILE_TO_NVDATA,
                                (UINT8*)fname,
                                256,
                                (UINT8*)0,
                                0,
...
MRESULT mrCCAPCDVTFlashCalibration_Cmd(const MUINT32 a_u4Argc, MUINT8 *a_pprArgv[])
{
    ...
    MUINT32 u4RetLen = 0;
    BOOL bRet = bSendDataToACDK(ACDK_CCT_OP_FLASH_CALIBRATION,
                                (UINT8*)0,
                                0,
                                (UINT8*)0,
                                0,
