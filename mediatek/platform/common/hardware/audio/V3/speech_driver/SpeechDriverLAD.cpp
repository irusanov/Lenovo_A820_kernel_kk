...
//#define skip_buff_message//Phone Call Test without buffer message transfer
...
status_t SpeechDriverLAD::SetSpeechMode(const audio_devices_t input_device, const audio_devices_t output_device)
{
    ...
    //Todo: refine speech mode check for ANC
    if (speech_mode == SPEECH_MODE_LOUD_SPEAKER)
    {
