...
static void S5K3H2YXMIPI_Init_Parameter(void)
{
    ...
    S5K3H2YXMIPI_sensor.mirror_flip = IMAGE_HV_MIRROR;  //normal:0, mirror:1, flip: 2, mirror_flip:3
	...
	SENSORDB("S5K3H2YXMIPIGetSensorID = 0x%04x\n", *sensorID); 
	 ...
	 if (*sensorID == S5K3H2YXMIPI_SENSOR_ID) 
	 {
           ...
           // S5K3L2X2DB("zjz: To ensure this segment will run. LensID = 0x%04x VcmID = 0x%04x\n", LensID, VcmID);
			...
			dev->device_type = "CCM";
			dev->device_module = "truly";
			dev->device_vendor	 ="truly";		  
			dev->device_ic	 = "S5K3H2YX";
                                                ...
                                                MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
   ...
   SENSORDB("[S5K3H2YXMIPI]%s()..................................................\n",__FUNCTION__);
	...
	//spin_unlock(&s5k3h2yxmipiraw_drv_lock); 
	 ...
	 S5K3H2YXMIPISetFlipMirror(S5K3H2YXMIPI_sensor.mirror_flip/*sensor_config_data->SensorImageMirror*/);
	 spin_lock(&s5k3h2yxmipiraw_drv_lock);
