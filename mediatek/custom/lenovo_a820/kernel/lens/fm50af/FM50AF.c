...
#define FM50AFDB(x,...)
#endif
/*Lenovo huangdra 20130930 add for smartt*/
...
/*lenovo-sw zhangjiano modify dw9718 setting*/
#ifdef DW9718
static int i2c_read(u8 a_u2Addr , u8 * a_puBuff)
{
    int  i4RetValue = 0;
    char puReadCmd[1] = {(char)(a_u2Addr)};
	i4RetValue = i2c_master_send(g_pstFM50AF_I2Cclient, puReadCmd, 1);
	if (i4RetValue != 2) {
	    FM50AFDB(" I2C write failed!! \n");
	    return -1;
	}
	//
	i4RetValue = i2c_master_recv(g_pstFM50AF_I2Cclient, (char *)a_puBuff, 1);
	if (i4RetValue != 1) {
	    FM50AFDB(" I2C read failed!! \n");
	    return -1;
	}
...
static int s4FM50AF_ReadReg(unsigned short * a_pu2Result)
{
    ...
    *a_pu2Result = (read_data(0x02) << 8) + (read_data(0x03)&0xff);
    ...
    FM50AFDB("[FM50AF]  s4FM50AF_ReadReg %d \n",  *a_pu2Result);
    return 0;
}
...
static int s4FM50AF_WriteReg(u16 a_u2Data)
{
    ...
    FM50AFDB("[FM50AF]  write %d \n",  a_u2Data);
	/*lenovo-sw zhangjiano modify dw9718 setting*/
	g_pstFM50AF_I2Cclient->ext_flag |= I2C_A_FILTER_MSG;
    i4RetValue = i2c_master_send(g_pstFM50AF_I2Cclient, puSendCmd, 3);
#endif
    if (i4RetValue < 0) 
    {
...
static int FM50AF_Open(struct inode * a_pstInode, struct file * a_pstFile)
{
	...
	/*lenovo-sw zhangjiano modify dw9718 setting*/
#ifdef DW9718
    char puSendCmd2[2] = {(char)(0x01) , (char)(0x39)};
   	i4RetValue = i2c_master_send(g_pstFM50AF_I2Cclient, puSendCmd2, 2);
	char puSendCmd3[2] = {(char)(0x05) , (char)(0x65)};
   	i4RetValue = i2c_master_send(g_pstFM50AF_I2Cclient, puSendCmd3, 2);
#else 
/*Lenovo huangdra 20130930 add for smartt*/
#if defined(LENOVO_PROJECT_S820)||defined(LENOVO_PROJECT_SMARTT)
    char puSendCmd[2] = {(char)(0xEC) , (char)(0xA3)};
   	i4RetValue = i2c_master_send(g_pstFM50AF_I2Cclient, puSendCmd, 2);
    		
    char puSendCmd2[2] = {(char)(0xA1) , (char)(0x0D)};
    i4RetValue = i2c_master_send(g_pstFM50AF_I2Cclient, puSendCmd2, 2);
    		
    char puSendCmd3[2] = {(char)(0xF2) , (char)(0x00)};
    i4RetValue = i2c_master_send(g_pstFM50AF_I2Cclient, puSendCmd3, 2);
