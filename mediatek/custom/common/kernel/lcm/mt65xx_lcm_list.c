...
extern LCM_DRIVER otm9608a_qhd_cmd_lcm_drv;
...
#if defined(OTM9608A_QHD_CMD)
	&otm9608a_qhd_cmd_lcm_drv,
#endif
...
#if defined(R63311_FHD_DSI_VDO_MALATA)
  &r63311_fhd_dsi_vdo_malata_lcm_drv,
#endif

#if defined(NT35517_DSI_VDO_QHD)
	&nt35517_dsi_vdo_qhd_lcm_drv,
#endif
