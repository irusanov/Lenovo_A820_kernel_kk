...
/*lenovo-sw add 2013.01.07*/
#if defined(MT9V113_MIPI_YUV)
    YUV_INFO(MT9V113_MIPI_SENSOR_ID, SENSOR_DRVNAME_MT9V113_MIPI_YUV, NULL),
#endif
    ...
    YUV_INFO(GC2035_SENSOR_ID, SENSOR_DRVNAME_GC2035_YUV,NULL), 
	 ...
	 RAW_INFO(S5K3H2YX_SENSOR_ID, SENSOR_DRVNAME_S5K3H2YX_MIPI_RAW,CAM_CALGetCalData), 
#endif

#if defined(GC2035MIPI_YUV)
    YUV_INFO(GC2035MIPI_SENSOR_ID, SENSOR_DRVNAME_GC2035MIPI_YUV,NULL), 
#endif
    ...
    YUV_INFO(SOC5140_SENSOR_ID, SENSOR_DRVNAME_SOC5140_MIPI_YUV, NULL), 
#endif
