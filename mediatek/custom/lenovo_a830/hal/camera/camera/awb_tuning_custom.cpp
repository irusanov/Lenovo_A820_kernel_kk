...
getAWBParam()
{
    static AWB_PARAM_T rAWBParam =
    {
    	...
    	{
#if defined(LENOVO_PROJECT_S820)
            50, // i4Speed: Convergence speed: (0 ~ 100)
            30,//225 // i4StableThr: Stable threshold ((currentRgain - targetRgain)^2 + (currentBgain - targetBgain)^2), WB gain format: 4.9
#elif defined(LENOVO_PROJECT_SNOOPY)||defined(LENOVO_PROJECT_SNOOPY_CU)
            50, // i4Speed: Convergence speed: (0 ~ 100)
            60,//225 // i4StableThr: Stable threshold ((currentRgain - targetRgain)^2 + (currentBgain - targetBgain)^2), WB gain format: 4.9
#else
    	...
    	// AWB gain prediction parameter
    	{
            ...
            // Daylight
    		{
    			   0, // i4IntermediateSceneLvThr_L1: useless
                   0, // i4IntermediateSceneLvThr_H1: useless
    			 170, // i4IntermediateSceneLvThr_L2
                 180, // i4IntermediateSceneLvThr_H2	//sunliang 170
    			   0, // i4DaylightLocusLvThr_L: useless
                   0  // i4DaylightLocusLvThr_H: useless
    		},
            // Daylight fluorescent
    		{
    			   0, // i4IntermediateSceneLvThr_L1: useless
                   0, // i4IntermediateSceneLvThr_H1: useless
    			  120, // i4IntermediateSceneLvThr_L2
                 140, // i4IntermediateSceneLvThr_H2
    			   0, // i4DaylightLocusLvThr_L: useless
                   0  // i4DaylightLocusLvThr_H: useless
    		},
            // Shade
...
getAWBStatParam()
{
    ...
    static AWB_STAT_PARAM_T rAWBStatParam =
    {
        ...
        // AWB error threshold
       	20 // Programmable threshold for the allowed total over-exposed and under-exposed pixels in one main stat window //sunliang 0
    };
