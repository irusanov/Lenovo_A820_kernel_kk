/*
 * drivers/cpufreq/cpufreq_thunderx.c
 *
 ...
 */
#define DEFAULT_AWAKE_IDEAL_FREQ 754000
 ...
 * also when suspended).
 */
#define DEFAULT_SLEEP_IDEAL_FREQ 497000
 ...
 */
#define DEFAULT_RAMP_UP_STEP 104000
 ...
 */
#define DEFAULT_RAMP_DOWN_STEP 104000
 ...
 */
#define DEFAULT_SLEEP_WAKEUP_FREQ 754000
...
#ifndef CONFIG_CPU_FREQ_DEFAULT_GOV_THUNDERX
static
#endif
struct cpufreq_governor cpufreq_gov_thunderx = {
	.name = "thunderx",
...
static int __init cpufreq_thunderx_init(void)
{
	...
	return cpufreq_register_governor(&cpufreq_gov_thunderx);
}

#ifdef CONFIG_CPU_FREQ_DEFAULT_GOV_THUNDERX
...
{
	cpufreq_unregister_governor(&cpufreq_gov_thunderx);
